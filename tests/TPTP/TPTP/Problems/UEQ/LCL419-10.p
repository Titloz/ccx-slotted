%------------------------------------------------------------------------------
% File     : LCL419-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
cnf(mv4,axiom,
    is_a_theorem(implies(implies(fnot(A),fnot(B)),implies(B,A))) = true ).

cnf(prove_ak1,negated_conjecture,
    is_a_theorem(implies(implies(implies(a,fnot(implies(implies(fnot(b),fnot(c)),fnot(c)))),fnot(implies(implies(fnot(b),fnot(c)),fnot(c)))),fnot(implies(implies(fnot(implies(implies(a,b),b)),fnot(implies(implies(a,c),c))),fnot(implies(implies(a,c),c)))))) != true ).
