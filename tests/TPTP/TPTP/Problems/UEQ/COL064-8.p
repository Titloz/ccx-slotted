%--------------------------------------------------------------------------
% File     : COL064-8 : TPTP v9.0.0. Bugfixed v1.2.0.
...
cnf(prove_v_combinator,negated_conjecture,
    apply(apply(apply(apply(apply(b,apply(apply(b,apply(t,apply(apply(b,b),t))),b)),apply(apply(b,t),t)),x),y),z) != apply(apply(z,x),y) ).
