%------------------------------------------------------------------------------
% File     : SWB012-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.14 v9.0.0, 0.11 v8.2.0, 0.20 v8.1.0, 0.00 v7.5.0
% Syntax   : Number of clauses     :  104 ( 104 unt;   0 nHn;  75 RR)
%            Number of literals    :  104 ( 104 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   59 (  59 usr;  50 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB012+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_012_Template_Class_12,axiom,
    iext(uri_owl_hasValue,sK2_testcase_premise_fullish_012_Template_Class_BNODE_r,uri_foaf_Person) = true ).

cnf(testcase_premise_fullish_012_Template_Class_11,axiom,
    iext(uri_owl_onProperty,sK2_testcase_premise_fullish_012_Template_Class_BNODE_r,uri_rdfs_domain) = true ).

cnf(testcase_premise_fullish_012_Template_Class_10,axiom,
    iext(uri_owl_intersectionOf,uri_ex_PersonAttribute,sK3_testcase_premise_fullish_012_Template_Class_BNODE_l1) = true ).

cnf(testcase_premise_fullish_012_Template_Class_9,axiom,
    iext(uri_rdf_rest,sK1_testcase_premise_fullish_012_Template_Class_BNODE_l3,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_012_Template_Class_8,axiom,
    iext(uri_rdf_rest,sK3_testcase_premise_fullish_012_Template_Class_BNODE_l1,sK4_testcase_premise_fullish_012_Template_Class_BNODE_l2) = true ).

cnf(testcase_premise_fullish_012_Template_Class_7,axiom,
    iext(uri_rdf_rest,sK4_testcase_premise_fullish_012_Template_Class_BNODE_l2,sK1_testcase_premise_fullish_012_Template_Class_BNODE_l3) = true ).

cnf(testcase_premise_fullish_012_Template_Class_6,axiom,
    iext(uri_rdf_first,sK1_testcase_premise_fullish_012_Template_Class_BNODE_l3,sK2_testcase_premise_fullish_012_Template_Class_BNODE_r) = true ).

cnf(testcase_premise_fullish_012_Template_Class_5,axiom,
    iext(uri_rdf_first,sK3_testcase_premise_fullish_012_Template_Class_BNODE_l1,uri_owl_DatatypeProperty) = true ).

cnf(testcase_premise_fullish_012_Template_Class_4,axiom,
    iext(uri_rdf_first,sK4_testcase_premise_fullish_012_Template_Class_BNODE_l2,uri_owl_FunctionalProperty) = true ).

cnf(testcase_premise_fullish_012_Template_Class_3,axiom,
    iext(uri_ex_name,uri_ex_alice,literal_plain(dat_str_alice)) = true ).

cnf(testcase_premise_fullish_012_Template_Class_2,axiom,
    iext(uri_rdf_type,sK2_testcase_premise_fullish_012_Template_Class_BNODE_r,uri_owl_Restriction) = true ).

cnf(testcase_premise_fullish_012_Template_Class_1,axiom,
    iext(uri_rdf_type,uri_foaf_Person,uri_owl_Class) = true ).

cnf(testcase_premise_fullish_012_Template_Class,axiom,
    iext(uri_rdf_type,uri_ex_name,uri_ex_PersonAttribute) = true ).

cnf(testcase_conclusion_fullish_012_Template_Class,negated_conjecture,
    tuple(iext(uri_rdf_type,uri_ex_alice,uri_foaf_Person),iext(uri_rdf_type,uri_ex_name,uri_owl_FunctionalProperty)) != tuple(true,true) ).
