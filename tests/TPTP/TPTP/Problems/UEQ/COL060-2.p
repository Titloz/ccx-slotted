%--------------------------------------------------------------------------
% File     : COL060-2 : TPTP v9.0.0. Bugfixed v1.2.0.
...
% Rating   : 0.05 v9.0.0, 0.00 v8.2.0, 0.08 v8.1.0, 0.10 v7.5.0, 0.08 v7.4.0, 0.13 v7.3.0, 0.05 v7.1.0, 0.00 v7.0.0, 0.05 v6.4.0, 0.11 v6.3.0, 0.06 v6.2.0, 0.07 v6.1.0, 0.00 v6.0.0, 0.05 v5.4.0, 0.00 v5.0.0, 0.07 v4.1.0, 0.09 v4.0.1, 0.07 v4.0.0, 0.08 v3.7.0, 0.11 v3.4.0, 0.12 v3.3.0, 0.00 v2.1.0, 0.29 v2.0.0
...
cnf(prove_q_combinator,negated_conjecture,
    apply(apply(apply(apply(apply(b,apply(t,b)),apply(apply(b,b),t)),x),y),z) != apply(y,apply(x,z)) ).
