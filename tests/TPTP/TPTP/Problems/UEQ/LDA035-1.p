%------------------------------------------------------------------------------
% File     : LDA035-1 : TPTP v9.0.0. Released v4.1.0.
% Domain   : LD-Algebras
% Problem  : Identity 32 in the equational theory of group conjugation
% Version  : Especial.
% English  :
...
% Status   : Satisfiable
% Rating   : 0.86 v9.0.0, 0.78 v8.2.0, 0.60 v8.1.0, 0.50 v7.5.0, 0.25 v7.1.0, 0.33 v7.0.0, 0.00 v6.4.0, 0.25 v6.3.0, 0.00 v6.2.0, 0.83 v6.1.0, 0.80 v5.5.0, 1.00 v5.2.0, 0.67 v5.0.0, 0.33 v4.1.0
...
cnf(sos04,axiom,
    product(product(product(A,B),product(product(A,C),C)),product(A,product(product(B,A),D))) = product(product(product(A,B),product(A,C)),product(product(product(A,B),product(C,A)),product(A,D))) ).
