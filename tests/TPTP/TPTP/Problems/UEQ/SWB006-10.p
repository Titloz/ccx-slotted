%------------------------------------------------------------------------------
% File     : SWB006-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Syntax   : Number of clauses     :   94 (  94 unt;   0 nHn;  65 RR)
%            Number of literals    :   94 (  94 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   47 (  47 usr;  39 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB006+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_006_Literal_Values_represented_by_URIs_and_Blank_Nodes_2,axiom,
    iext(uri_owl_sameAs,sK1_testcase_premise_fullish_006_Literal_Values_represented_by_URIs_and_Blank_Nodes_BNODE_x,literal_plain(dat_str_abc)) = true ).

cnf(testcase_premise_fullish_006_Literal_Values_represented_by_URIs_and_Blank_Nodes_1,axiom,
    iext(uri_owl_sameAs,sK1_testcase_premise_fullish_006_Literal_Values_represented_by_URIs_and_Blank_Nodes_BNODE_x,uri_ex_w) = true ).

cnf(testcase_premise_fullish_006_Literal_Values_represented_by_URIs_and_Blank_Nodes,axiom,
    iext(uri_owl_sameAs,uri_ex_u,literal_plain(dat_str_abc)) = true ).

cnf(testcase_conclusion_fullish_006_Literal_Values_represented_by_URIs_and_Blank_Nodes,negated_conjecture,
    iext(uri_owl_sameAs,uri_ex_u,uri_ex_w) != true ).
