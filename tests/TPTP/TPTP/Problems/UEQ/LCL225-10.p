%------------------------------------------------------------------------------
% File     : LCL225-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Rating   : 0.95 v8.2.0, 0.96 v8.1.0, 1.00 v7.3.0
...
cnf(prove_this,negated_conjecture,
    theorem(or(fnot(or(fnot(p),or(fnot(q),r))),or(fnot(or(fnot(p),q)),or(fnot(p),r)))) != true ).
