%------------------------------------------------------------------------------
% File     : LCL292-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.57 v9.0.0, 0.33 v8.2.0, 0.00 v8.1.0, 0.25 v7.5.0, 0.00 v7.3.0
...
cnf(prove_this,negated_conjecture,
    theorem(equivalent(and(fnot(p),fnot(q)),or(p,q))) != true ).
