%------------------------------------------------------------------------------
% File     : AGT042-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
cnf(event_11,axiom,
    the_agent_fnot_in_any_proposed_teams(muslimcountrybhumanitarianorganization,countryacivilorganization,towna) = true ).
...
cnf(event_37,axiom,
    the_agent_fnot_in_any_proposed_teams(countryamedicalorganization,christiancountrychumanitarianorganization,coastvillage) = true ).
...
cnf(event_248,axiom,
    the_agent_fnot_in_any_proposed_teams(muslimcountrybhumanitarianorganization,sufferterragovernment,towna) = true ).
...
cnf(a1_6,axiom,
    ifeq(tuple(accept_city(A,C),accept_leader(A,L),the_agent_fnot_in_any_proposed_teams(A,L,C)),tuple(true,true,true),a,b) = b ).
