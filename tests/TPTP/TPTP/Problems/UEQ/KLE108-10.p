%------------------------------------------------------------------------------
% File     : KLE108-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Galois
% Version  : Especial.
% English  :
...
% Rating   : 0.77 v8.2.0, 0.83 v8.1.0, 0.85 v7.5.0
% Syntax   : Number of clauses     :   31 (  31 unt;   0 nHn;   2 RR)
...
% Comments : Converted from KLE108+1 to UEQ using [CS18].
%------------------------------------------------------------------------------
