%------------------------------------------------------------------------------
% File     : LCL423-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
cnf(luka23,axiom,
    is_a_theorem(implies(implies(implies(A,B),implies(implies(implies(fnot(C),fnot(D)),E),C)),implies(F,implies(implies(C,A),implies(D,A))))) = true ).

cnf(prove_luka_3_basis,negated_conjecture,
    tuple(is_a_theorem(implies(implies(fnot(a),a),a)),is_a_theorem(implies(implies(a,b),implies(implies(b,c),implies(a,c)))),is_a_theorem(implies(a,implies(fnot(a),b)))) != tuple(true,true,true) ).
