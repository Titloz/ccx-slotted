%------------------------------------------------------------------------------
% File     : GRP714-1 : TPTP v9.0.0. Released v4.0.0.
% Domain   : Group Theory (Quasigroups)
% Problem  : In Buchsteiner loops fourth powers are nuclear - c
% Version  : Especial.
% English  :
...
cnf(goals,negated_conjecture,
    mult(a,mult(b,mult(c,mult(c,mult(c,c))))) != mult(mult(a,b),mult(c,mult(c,mult(c,c)))) ).
