%------------------------------------------------------------------------------
% File     : LCL270-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 4.22
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL270-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(implies(and(equivalent(p,q),equivalent(q,r)),equivalent(p,r))) != true ).
