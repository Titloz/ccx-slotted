%------------------------------------------------------------------------------
% File     : NLP244-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Comments : Converted from NLP244-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause74,negated_conjecture,
    vincent_forename(skc14,skc26) = true ).

cnf(clause75,negated_conjecture,
    forename(skc14,skc26) = true ).

cnf(clause76,negated_conjecture,
    think_believe_consider(skc14,skc25) = true ).

cnf(clause77,negated_conjecture,
    present(skc14,skc25) = true ).

cnf(clause78,negated_conjecture,
    event(skc14,skc25) = true ).

cnf(clause79,negated_conjecture,
    event(skc15,skc23) = true ).

cnf(clause80,negated_conjecture,
    man(skc14,skc22) = true ).

cnf(clause81,negated_conjecture,
    present(skc15,skc23) = true ).

cnf(clause82,negated_conjecture,
    smoke(skc15,skc23) = true ).

cnf(clause83,negated_conjecture,
    forename(skc14,skc19) = true ).

cnf(clause84,negated_conjecture,
    jules_forename(skc14,skc19) = true ).

cnf(clause85,negated_conjecture,
    man(skc14,skc18) = true ).

cnf(clause86,negated_conjecture,
    vincent_forename(skc14,skc20) = true ).

cnf(clause87,negated_conjecture,
    forename(skc14,skc20) = true ).

cnf(clause88,negated_conjecture,
    state(skc14,skc17) = true ).
...
cnf(clause95,negated_conjecture,
    jules_forename(skc14,skc21) = true ).

cnf(clause96,negated_conjecture,
    proposition(skc14,skc24) = true ).

cnf(clause97,negated_conjecture,
    accessible_world(skc14,skc24) = true ).

cnf(clause98,negated_conjecture,
    agent(skc14,skc25,skc27) = true ).

cnf(clause99,negated_conjecture,
    of(skc14,skc26,skc27) = true ).

cnf(clause100,negated_conjecture,
    theme(skc14,skc25,skc24) = true ).

cnf(clause101,negated_conjecture,
    of(skc14,skc21,skc22) = true ).

cnf(clause102,negated_conjecture,
    agent(skc15,skc23,skc22) = true ).

cnf(clause103,negated_conjecture,
    of(skc14,skc20,skc18) = true ).

cnf(clause104,negated_conjecture,
    of(skc14,skc19,skc18) = true ).
...
cnf(clause107,negated_conjecture,
    be(skc14,skc17,skc18,skc18) = true ).

cnf(clause108,negated_conjecture,
    ifeq2(man(skc24,U),true,smoke(skc24,skf1(V)),true) = true ).

cnf(clause109,negated_conjecture,
    ifeq2(man(skc24,U),true,present(skc24,skf1(V)),true) = true ).

cnf(clause110,negated_conjecture,
    ifeq2(man(skc24,U),true,event(skc24,skf1(V)),true) = true ).

cnf(clause111,negated_conjecture,
    ifeq2(man(skc24,U),true,agent(skc24,skf1(U),U),true) = true ).
