%------------------------------------------------------------------------------
% File     : SWB016-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
%            Number of functors    :   42 (  42 usr;  35 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB016+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_conclusion_fullish_016_Reflective_Tautologies_II,negated_conjecture,
    iext(uri_rdfs_subPropertyOf,uri_owl_equivalentClass,uri_rdfs_subClassOf) != true ).
