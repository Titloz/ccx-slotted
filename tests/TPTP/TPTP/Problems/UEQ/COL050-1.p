%--------------------------------------------------------------------------
% File     : COL050-1 : TPTP v9.0.0. Released v1.0.0.
...
% Rating   : 0.09 v8.2.0, 0.08 v8.1.0, 0.10 v7.5.0, 0.08 v7.4.0, 0.13 v7.3.0, 0.11 v7.1.0, 0.06 v7.0.0, 0.00 v6.4.0, 0.05 v6.3.0, 0.06 v6.2.0, 0.07 v6.1.0, 0.00 v6.0.0, 0.10 v5.5.0, 0.05 v5.4.0, 0.00 v5.1.0, 0.07 v5.0.0, 0.00 v2.0.0
...
%----    Letting A = x,
%----    -[response(A,y) = y].
cnf(prove_all_fond_of_afnother,negated_conjecture,
    response(a,Y) != Y ).
