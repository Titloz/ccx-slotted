%------------------------------------------------------------------------------
% File     : GRP658-10 : TPTP v9.0.0. Released v8.1.0.
% Domain   : Group Theory (Quasigroups)
% Problem  : Bol-Moufang identity 1 implies the existence of a unit element
% Version  : Especial.
% English  :
...
% Rating   : 0.18 v8.2.0, 0.25 v8.1.0
...
% Comments : UEQ version, converted from GRP658+1.p
%------------------------------------------------------------------------------
cnf(f01,axiom,
    mult(A,ld(A,B)) = B ).
...
cnf(f05,axiom,
    mult(mult(A,mult(B,B)),C) = mult(mult(A,B),mult(B,C)) ).
