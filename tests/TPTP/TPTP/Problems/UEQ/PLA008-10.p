%------------------------------------------------------------------------------
% File     : PLA008-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Block B on D and A on C
% Version  : Especial.
% English  :
...
% Comments : Converted from PLA008-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_BD_AC,negated_conjecture,
    holds(and(on(b,d),on(a,c)),State) != true ).
