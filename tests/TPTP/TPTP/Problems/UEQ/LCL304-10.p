%------------------------------------------------------------------------------
% File     : LCL304-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 4.72
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL304-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(equivalent(implies(p,q),equivalent(q,or(p,q)))) != true ).
