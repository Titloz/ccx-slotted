%------------------------------------------------------------------------------
% File     : SWB009-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Comments : Converted from SWB009+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_009_Existential_Restriction_Entailments_5,axiom,
    iext(uri_owl_someValuesFrom,sK1_testcase_premise_fullish_009_Existential_Restriction_Entailments_BNODE_z,uri_ex_c) = true ).

cnf(testcase_premise_fullish_009_Existential_Restriction_Entailments_4,axiom,
    iext(uri_owl_onProperty,sK1_testcase_premise_fullish_009_Existential_Restriction_Entailments_BNODE_z,uri_ex_p) = true ).

cnf(testcase_premise_fullish_009_Existential_Restriction_Entailments_3,axiom,
    iext(uri_rdf_type,sK1_testcase_premise_fullish_009_Existential_Restriction_Entailments_BNODE_z,uri_owl_Restriction) = true ).

cnf(testcase_premise_fullish_009_Existential_Restriction_Entailments_2,axiom,
    iext(uri_rdf_type,uri_ex_c,uri_owl_Class) = true ).

cnf(testcase_premise_fullish_009_Existential_Restriction_Entailments_1,axiom,
    iext(uri_rdf_type,uri_ex_s,sK1_testcase_premise_fullish_009_Existential_Restriction_Entailments_BNODE_z) = true ).

cnf(testcase_premise_fullish_009_Existential_Restriction_Entailments,axiom,
    iext(uri_rdf_type,uri_ex_p,uri_owl_ObjectProperty) = true ).

cnf(testcase_conclusion_fullish_009_Existential_Restriction_Entailments,negated_conjecture,
    tuple(iext(uri_rdf_type,BNODE_x,uri_ex_c),iext(uri_ex_p,uri_ex_s,BNODE_x)) != tuple(true,true) ).
