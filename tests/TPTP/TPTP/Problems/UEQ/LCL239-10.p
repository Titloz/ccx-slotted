%------------------------------------------------------------------------------
% File     : LCL239-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Rating   : 0.18 v8.2.0, 0.25 v7.5.0
...
% Comments : Converted from LCL239-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(fnot(and(p,fnot(p)))) != true ).
