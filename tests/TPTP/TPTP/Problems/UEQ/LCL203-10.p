%------------------------------------------------------------------------------
% File     : LCL203-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Rating   : 0.27 v8.2.0, 0.33 v8.1.0, 0.30 v7.5.0, 0.38 v7.4.0, 0.39 v7.3.0
...
cnf(prove_this,negated_conjecture,
    theorem(implies(fnot(or(p,q)),or(fnot(p),fnot(q)))) != true ).
