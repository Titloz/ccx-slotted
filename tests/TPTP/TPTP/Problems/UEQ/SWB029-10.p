%------------------------------------------------------------------------------
% File     : SWB029-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Syntax   : Number of clauses     :  100 ( 100 unt;   0 nHn;  71 RR)
%            Number of literals    :  100 ( 100 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   51 (  51 usr;  44 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB029+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_029_Ex_Falso_Quodlibet_8,axiom,
    iext(uri_owl_complementOf,sK1_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_y,uri_ex_A) = true ).

cnf(testcase_premise_fullish_029_Ex_Falso_Quodlibet_7,axiom,
    iext(uri_owl_intersectionOf,sK3_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_x,sK4_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_l1) = true ).

cnf(testcase_premise_fullish_029_Ex_Falso_Quodlibet_6,axiom,
    iext(uri_rdf_rest,sK2_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_l2,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_029_Ex_Falso_Quodlibet_5,axiom,
    iext(uri_rdf_rest,sK4_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_l1,sK2_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_l2) = true ).

cnf(testcase_premise_fullish_029_Ex_Falso_Quodlibet_4,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_l2,sK1_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_y) = true ).

cnf(testcase_premise_fullish_029_Ex_Falso_Quodlibet_3,axiom,
    iext(uri_rdf_first,sK4_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_l1,uri_ex_A) = true ).

cnf(testcase_premise_fullish_029_Ex_Falso_Quodlibet_2,axiom,
    iext(uri_rdf_type,uri_ex_A,uri_owl_Class) = true ).

cnf(testcase_premise_fullish_029_Ex_Falso_Quodlibet_1,axiom,
    iext(uri_rdf_type,uri_ex_B,uri_owl_Class) = true ).

cnf(testcase_premise_fullish_029_Ex_Falso_Quodlibet,axiom,
    iext(uri_rdf_type,uri_ex_w,sK3_testcase_premise_fullish_029_Ex_Falso_Quodlibet_BNODE_x) = true ).

cnf(testcase_conclusion_fullish_029_Ex_Falso_Quodlibet,negated_conjecture,
    iext(uri_rdf_type,uri_ex_w,uri_ex_B) != true ).
