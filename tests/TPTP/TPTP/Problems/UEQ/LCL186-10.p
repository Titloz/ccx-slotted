%------------------------------------------------------------------------------
% File     : LCL186-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 2.21
% Version  : Especial.
% English  :
...
% Rating   : 0.14 v9.0.0, 0.18 v8.2.0, 0.17 v8.1.0, 0.15 v7.5.0
...
% Comments : Converted from LCL186-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(or(fnot(fnot(p)),or(fnot(p),q))) != true ).
