%------------------------------------------------------------------------------
% File     : NLP248-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.43 v9.0.0, 0.11 v8.2.0, 0.20 v8.1.0, 0.25 v7.5.0
...
% Comments : Converted from NLP248-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause73,negated_conjecture,
    event(skc14,skc26) = true ).

cnf(clause74,negated_conjecture,
    jules_forename(skc13,skc24) = true ).
...
cnf(clause78,negated_conjecture,
    present(skc14,skc26) = true ).

cnf(clause79,negated_conjecture,
    smoke(skc14,skc26) = true ).
...
cnf(clause96,negated_conjecture,
    state(skc13,skc22) = true ).

cnf(clause97,negated_conjecture,
    of(skc13,skc25,skc23) = true ).

cnf(clause98,negated_conjecture,
    of(skc13,skc24,skc23) = true ).

cnf(clause99,negated_conjecture,
    agent(skc14,skc26,skc23) = true ).
...
cnf(clause106,negated_conjecture,
    be(skc13,skc22,skc23,skc23) = true ).
