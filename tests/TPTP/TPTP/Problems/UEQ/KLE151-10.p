%------------------------------------------------------------------------------
% File     : KLE151-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Rating   : 0.82 v8.2.0, 0.88 v8.1.0, 0.90 v7.5.0, 0.83 v7.3.0
...
% Comments : Converted from KLE151+1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(goals,negated_conjecture,
    leq(multiplication(sK2_goals_X0,strong_iteration(multiplication(sK1_goals_X1,sK2_goals_X0))),multiplication(strong_iteration(multiplication(sK2_goals_X0,sK1_goals_X1)),sK2_goals_X0)) != true ).
