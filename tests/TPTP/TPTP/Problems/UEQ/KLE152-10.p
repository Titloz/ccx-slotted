%------------------------------------------------------------------------------
% File     : KLE152-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Comments : Converted from KLE152+1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(goals,negated_conjecture,
    leq(multiplication(strong_iteration(multiplication(sK2_goals_X0,sK1_goals_X1)),sK2_goals_X0),multiplication(sK2_goals_X0,strong_iteration(multiplication(sK1_goals_X1,sK2_goals_X0)))) != true ).
