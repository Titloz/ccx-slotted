%------------------------------------------------------------------------------
% File     : LCL195-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Rating   : 0.95 v9.0.0, 0.91 v8.2.0, 0.96 v8.1.0, 0.95 v7.5.0, 1.00 v7.3.0
...
% Comments : Converted from LCL195-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(implies(implies(q,r),implies(or(q,p),or(r,p)))) != true ).
