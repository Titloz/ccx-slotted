%--------------------------------------------------------------------------
% File     : COL063-6 : TPTP v9.0.0. Bugfixed v1.2.0.
...
cnf(prove_f_combinator,negated_conjecture,
    apply(apply(apply(apply(apply(b,apply(apply(b,apply(apply(b,apply(t,t)),b)),b)),t),x),y),z) != apply(apply(z,y),x) ).
