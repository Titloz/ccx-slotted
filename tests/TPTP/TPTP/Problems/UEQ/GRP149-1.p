%--------------------------------------------------------------------------
% File     : GRP149-1 : TPTP v9.0.0. Bugfixed v1.2.1.
...
% Rating   : 0.00 v8.2.0, 0.04 v8.1.0, 0.05 v7.5.0, 0.04 v7.4.0, 0.09 v7.3.0, 0.00 v7.0.0, 0.11 v6.3.0, 0.06 v6.2.0, 0.07 v6.1.0, 0.06 v6.0.0, 0.10 v5.5.0, 0.05 v5.4.0, 0.00 v3.4.0, 0.12 v3.3.0, 0.00 v2.2.1, 0.22 v2.2.0, 0.29 v2.1.0, 0.14 v2.0.0
...
%--------------------------------------------------------------------------
cnf(ax_lub1d_1,hypothesis,
    greatest_lower_bound(a,c) = a ).

cnf(ax_lub1d_2,hypothesis,
    greatest_lower_bound(b,c) = b ).

cnf(prove_ax_lub1d,negated_conjecture,
