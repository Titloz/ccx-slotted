%------------------------------------------------------------------------------
% File     : NLP249-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Vincent believes that every man smokes, problem 30
% Version  : Especial.
% English  :
...
% Status   : Satisfiable
% Rating   : 0.29 v9.0.0, 0.22 v8.2.0, 0.20 v8.1.0, 0.25 v7.5.0, 0.50 v7.3.0
% Syntax   : Number of clauses     :  114 ( 114 unt;   0 nHn;  36 RR)
%            Number of literals    :  114 ( 114 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :   10 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   57 (  57 usr;  16 con; 0-4 aty)
%            Number of variables   :  205 (  11 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from NLP249-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause72,negated_conjecture,
    actual_world(skc13) = true ).

cnf(clause73,negated_conjecture,
    jules_forename(skc13,skc26) = true ).

cnf(clause74,negated_conjecture,
    forename(skc13,skc26) = true ).

cnf(clause75,negated_conjecture,
    man(skc13,skc25) = true ).

cnf(clause76,negated_conjecture,
    event(skc14,skc21) = true ).

cnf(clause77,negated_conjecture,
    forename(skc13,skc20) = true ).

cnf(clause78,negated_conjecture,
    vincent_forename(skc13,skc20) = true ).

cnf(clause79,negated_conjecture,
    man(skc13,skc19) = true ).

cnf(clause80,negated_conjecture,
    present(skc14,skc21) = true ).

cnf(clause81,negated_conjecture,
    smoke(skc14,skc21) = true ).

cnf(clause82,negated_conjecture,
    jules_forename(skc13,skc22) = true ).

cnf(clause83,negated_conjecture,
    forename(skc13,skc22) = true ).

cnf(clause84,negated_conjecture,
    forename(skc13,skc18) = true ).

cnf(clause85,negated_conjecture,
    vincent_forename(skc13,skc18) = true ).

cnf(clause86,negated_conjecture,
    event(skc13,skc17) = true ).

cnf(clause87,negated_conjecture,
    present(skc13,skc17) = true ).

cnf(clause88,negated_conjecture,
    think_believe_consider(skc13,skc17) = true ).

cnf(clause89,negated_conjecture,
    think_believe_consider(skc13,skc15) = true ).

cnf(clause90,negated_conjecture,
    present(skc13,skc15) = true ).

cnf(clause91,negated_conjecture,
    event(skc13,skc15) = true ).

cnf(clause92,negated_conjecture,
    accessible_world(skc13,skc16) = true ).

cnf(clause93,negated_conjecture,
    proposition(skc13,skc16) = true ).

cnf(clause94,negated_conjecture,
    proposition(skc13,skc14) = true ).

cnf(clause95,negated_conjecture,
    accessible_world(skc13,skc14) = true ).

cnf(clause96,negated_conjecture,
    state(skc13,skc24) = true ).

cnf(clause97,negated_conjecture,
    of(skc13,skc26,skc25) = true ).

cnf(clause98,negated_conjecture,
    of(skc13,skc22,skc19) = true ).

cnf(clause99,negated_conjecture,
    of(skc13,skc20,skc19) = true ).

cnf(clause100,negated_conjecture,
    of(skc13,skc18,skc19) = true ).

cnf(clause101,negated_conjecture,
    agent(skc13,skc17,skc19) = true ).

cnf(clause102,negated_conjecture,
    agent(skc13,skc15,skc19) = true ).

cnf(clause103,negated_conjecture,
    agent(skc14,skc21,skc19) = true ).

cnf(clause104,negated_conjecture,
    theme(skc13,skc17,skc16) = true ).

cnf(clause105,negated_conjecture,
    theme(skc13,skc15,skc14) = true ).

cnf(clause106,negated_conjecture,
    be(skc13,skc24,skc25,skc25) = true ).

cnf(clause107,negated_conjecture,
    ifeq2(man(skc16,U),true,smoke(skc16,skf1(V)),true) = true ).

cnf(clause108,negated_conjecture,
    ifeq2(man(skc16,U),true,present(skc16,skf1(V)),true) = true ).

cnf(clause109,negated_conjecture,
    ifeq2(man(skc16,U),true,event(skc16,skf1(V)),true) = true ).

cnf(clause110,negated_conjecture,
    ifeq2(man(skc16,U),true,agent(skc16,skf1(U),U),true) = true ).
