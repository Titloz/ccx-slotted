%------------------------------------------------------------------------------
% File     : SWB013-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Cliques
% Version  : Especial.
% English  :
...
% Status   : Satisfiable
% Rating   : 0.14 v9.0.0, 0.11 v8.2.0, 0.00 v7.5.0, 0.25 v7.3.0
...
% Comments : Converted from SWB013+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_013_Cliques_18,axiom,
    iext(uri_owl_inverseOf,sK3_testcase_premise_fullish_013_Cliques_BNODE_i,uri_rdf_type) = true ).

cnf(testcase_premise_fullish_013_Cliques_17,axiom,
    iext(uri_owl_propertyChainAxiom,uri_foaf_knows,sK1_testcase_premise_fullish_013_Cliques_BNODE_l1) = true ).

cnf(testcase_premise_fullish_013_Cliques_16,axiom,
    iext(uri_owl_someValuesFrom,sK5_testcase_premise_fullish_013_Cliques_BNODE_r,uri_ex_Clique) = true ).

cnf(testcase_premise_fullish_013_Cliques_15,axiom,
    iext(uri_owl_onProperty,sK5_testcase_premise_fullish_013_Cliques_BNODE_r,uri_ex_sameCliqueAs) = true ).

cnf(testcase_premise_fullish_013_Cliques_14,axiom,
    iext(uri_rdfs_range,uri_ex_sameCliqueAs,uri_ex_Clique) = true ).

cnf(testcase_premise_fullish_013_Cliques_13,axiom,
    iext(uri_rdf_rest,sK1_testcase_premise_fullish_013_Cliques_BNODE_l1,sK2_testcase_premise_fullish_013_Cliques_BNODE_l2) = true ).

cnf(testcase_premise_fullish_013_Cliques_12,axiom,
    iext(uri_rdf_rest,sK2_testcase_premise_fullish_013_Cliques_BNODE_l2,sK4_testcase_premise_fullish_013_Cliques_BNODE_l3) = true ).

cnf(testcase_premise_fullish_013_Cliques_11,axiom,
    iext(uri_rdf_rest,sK4_testcase_premise_fullish_013_Cliques_BNODE_l3,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_013_Cliques_10,axiom,
    iext(uri_rdf_first,sK1_testcase_premise_fullish_013_Cliques_BNODE_l1,uri_rdf_type) = true ).

cnf(testcase_premise_fullish_013_Cliques_9,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_013_Cliques_BNODE_l2,uri_ex_sameCliqueAs) = true ).

cnf(testcase_premise_fullish_013_Cliques_8,axiom,
    iext(uri_rdf_first,sK4_testcase_premise_fullish_013_Cliques_BNODE_l3,sK3_testcase_premise_fullish_013_Cliques_BNODE_i) = true ).

cnf(testcase_premise_fullish_013_Cliques_7,axiom,
    iext(uri_rdf_type,sK5_testcase_premise_fullish_013_Cliques_BNODE_r,uri_owl_Restriction) = true ).

cnf(testcase_premise_fullish_013_Cliques_6,axiom,
    iext(uri_rdf_type,uri_ex_JoesGang,uri_ex_Clique) = true ).

cnf(testcase_premise_fullish_013_Cliques_5,axiom,
    iext(uri_rdf_type,uri_ex_Clique,uri_owl_Class) = true ).

cnf(testcase_premise_fullish_013_Cliques_4,axiom,
    iext(uri_rdf_type,uri_ex_bob,uri_ex_JoesGang) = true ).

cnf(testcase_premise_fullish_013_Cliques_3,axiom,
    iext(uri_rdf_type,uri_ex_alice,uri_ex_JoesGang) = true ).

cnf(testcase_premise_fullish_013_Cliques_2,axiom,
    iext(uri_rdf_type,uri_foaf_knows,uri_owl_ObjectProperty) = true ).

cnf(testcase_premise_fullish_013_Cliques_1,axiom,
    iext(uri_rdfs_subPropertyOf,uri_ex_sameCliqueAs,uri_owl_sameAs) = true ).

cnf(testcase_premise_fullish_013_Cliques,axiom,
    iext(uri_rdfs_subClassOf,uri_ex_Clique,sK5_testcase_premise_fullish_013_Cliques_BNODE_r) = true ).

cnf(testcase_conclusion_fullish_013_Cliques,negated_conjecture,
    iext(uri_foaf_knows,uri_ex_alice,uri_ex_bob) != true ).
