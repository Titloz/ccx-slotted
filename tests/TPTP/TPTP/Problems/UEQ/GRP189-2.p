%--------------------------------------------------------------------------
% File     : GRP189-2 : TPTP v9.0.0. Bugfixed v1.2.1.
...
% Rating   : 0.00 v7.4.0, 0.04 v7.3.0, 0.00 v7.0.0, 0.05 v6.3.0, 0.06 v6.2.0, 0.07 v6.1.0, 0.06 v6.0.0, 0.10 v5.5.0, 0.05 v5.4.0, 0.00 v5.1.0, 0.07 v4.1.0, 0.09 v4.0.1, 0.07 v4.0.0, 0.08 v3.7.0, 0.00 v2.0.0
...
%--------------------------------------------------------------------------
cnf(p38b_1,hypothesis,
    inverse(identity) = identity ).

cnf(p38b_2,hypothesis,
    inverse(inverse(X)) = X ).

cnf(p38b_3,hypothesis,
