...
cnf(c56_is_fnot_p34_2,negated_conjecture,
    ifeq(p34(c56),true,a,b) = b ).

cnf(fnot_p35_11,negated_conjecture,
    ifeq(p35(c56,c58),true,a,b) = b ).

cnf(fnot_p35_12,negated_conjecture,
    ifeq(p35(c56,c57),true,a,b) = b ).

cnf(fnot_p36_14,negated_conjecture,
    ifeq(p36(f15(c56),c47),true,a,b) = b ).

cnf(fnot_p39_69,negated_conjecture,
