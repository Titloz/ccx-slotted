%------------------------------------------------------------------------------
% File     : LCL384-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Rating   : 0.73 v9.0.0, 0.82 v8.2.0, 0.83 v8.1.0, 0.80 v7.5.0
...
% Comments : Converted from LCL384-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_cn_45,negated_conjecture,
    is_a_theorem(implies(implies(x,implies(y,z)),implies(implies(fnot(z),y),implies(x,z)))) != true ).
