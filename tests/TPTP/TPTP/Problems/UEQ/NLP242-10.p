%------------------------------------------------------------------------------
% File     : NLP242-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Comments : Converted from NLP242-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause83,negated_conjecture,
    present(skc15,skc22) = true ).

cnf(clause84,negated_conjecture,
    smoke(skc15,skc22) = true ).
...
cnf(clause101,negated_conjecture,
    of(skc14,skc23,skc20) = true ).

cnf(clause102,negated_conjecture,
    of(skc14,skc21,skc20) = true ).

cnf(clause103,negated_conjecture,
    agent(skc15,skc22,skc20) = true ).
...
cnf(clause107,negated_conjecture,
    be(skc14,skc19,skc20,skc20) = true ).
