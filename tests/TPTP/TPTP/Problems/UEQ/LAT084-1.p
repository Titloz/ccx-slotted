%--------------------------------------------------------------------------
% File     : LAT084-1 : TPTP v9.0.0. Released v2.6.0.
...
% Rating   : 0.50 v8.2.0, 0.58 v8.1.0, 0.70 v7.5.0, 0.62 v7.4.0, 0.65 v7.3.0, 0.68 v7.1.0, 0.61 v7.0.0, 0.58 v6.4.0, 0.63 v6.3.0, 0.65 v6.2.0, 0.64 v6.1.0, 0.69 v6.0.0, 0.76 v5.5.0, 0.74 v5.4.0, 0.67 v5.2.0, 0.64 v5.1.0, 0.67 v5.0.0, 0.64 v4.0.0, 0.62 v3.7.0, 0.67 v3.4.0, 0.75 v3.3.0, 0.50 v3.1.0, 0.56 v2.7.0, 0.64 v2.6.0
...
cnf(prove_normal_axioms_5,negated_conjecture,
    join(a,b) != join(b,a) ).
