%------------------------------------------------------------------------------
% File     : LCL339-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 5.42
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL339-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(equivalent(implies(p,implies(q,r)),implies(p,implies(q,and(p,r))))) != true ).
