%------------------------------------------------------------------------------
% File     : NLP240-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Vincent believes that every man smokes, problem 21
% Version  : Especial.
% English  :
...
% Comments : Converted from NLP240-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause85,negated_conjecture,
    present(skc15,skc20) = true ).

cnf(clause86,negated_conjecture,
    smoke(skc15,skc20) = true ).
...
cnf(clause107,negated_conjecture,
    be(skc14,skc21,skc22,skc22) = true ).
