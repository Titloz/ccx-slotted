%------------------------------------------------------------------------------
% File     : LCL385-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : CN-47 depends on the Lukasiewicz system
% Version  : Especial.
% English  :
...
% Rating   : 0.73 v8.2.0, 0.75 v8.1.0, 0.60 v7.5.0
...
% Comments : Converted from LCL385-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_cn_47,negated_conjecture,
    is_a_theorem(implies(implies(x,fnot(y)),implies(y,fnot(x)))) != true ).
