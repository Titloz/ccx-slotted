%------------------------------------------------------------------------------
% File     : LCL060-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Rating   : 0.91 v9.0.0, 0.86 v8.2.0, 0.92 v8.1.0, 0.90 v7.5.0, 0.88 v7.4.0, 0.96 v7.3.0
...
% Comments : Converted from LCL060-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_cn_54,negated_conjecture,
    is_a_theorem(implies(implies(a,b),implies(implies(fnot(a),b),b))) != true ).
