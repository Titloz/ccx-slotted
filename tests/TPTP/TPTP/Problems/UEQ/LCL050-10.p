%------------------------------------------------------------------------------
% File     : LCL050-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : CN-21 depends on the Lukasiewicz system
% Version  : Especial.
% English  :
...
% Rating   : 0.50 v9.0.0, 0.55 v8.2.0, 0.54 v8.1.0, 0.40 v7.5.0, 0.54 v7.4.0, 0.61 v7.3.0
...
% Comments : Converted from LCL050-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
