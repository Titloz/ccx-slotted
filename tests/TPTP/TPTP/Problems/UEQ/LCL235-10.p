%------------------------------------------------------------------------------
% File     : LCL235-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 3.13
% Version  : Especial.
% English  :
...
% Status   : Satisfiable
% Rating   : 0.71 v9.0.0, 0.56 v8.2.0, 0.40 v8.1.0, 0.50 v7.5.0
...
% Comments : Converted from LCL235-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(or(fnot(fnot(fnot(or(fnot(p),fnot(q))))),or(fnot(p),fnot(q)))) != true ).
