%------------------------------------------------------------------------------
% File     : LCL244-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 3.33
% Version  : Especial.
% English  :
...
% Status   : Satisfiable
% Rating   : 0.71 v9.0.0, 0.56 v8.2.0, 0.40 v8.1.0, 0.50 v7.3.0
...
% Comments : Converted from LCL244-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(or(fnot(fnot(or(fnot(or(fnot(p),q)),fnot(or(fnot(q),r))))),or(fnot(p),r))) != true ).
