%------------------------------------------------------------------------------
% File     : SWB027-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Syntax   : Number of clauses     :   97 (  97 unt;   0 nHn;  68 RR)
%            Number of literals    :   97 (  97 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   49 (  49 usr;  42 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB027+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_027_Inferred_Property_Characteristics_II_5,axiom,
    iext(uri_owl_inverseOf,sK1_testcase_premise_fullish_027_Inferred_Property_Characteristics_II_BNODE_v,uri_ex_p) = true ).

cnf(testcase_premise_fullish_027_Inferred_Property_Characteristics_II_4,axiom,
    iext(uri_owl_propertyChainAxiom,uri_owl_sameAs,sK2_testcase_premise_fullish_027_Inferred_Property_Characteristics_II_BNODE_l1) = true ).

cnf(testcase_premise_fullish_027_Inferred_Property_Characteristics_II_3,axiom,
    iext(uri_rdf_rest,sK2_testcase_premise_fullish_027_Inferred_Property_Characteristics_II_BNODE_l1,sK3_testcase_premise_fullish_027_Inferred_Property_Characteristics_II_BNODE_l2) = true ).

cnf(testcase_premise_fullish_027_Inferred_Property_Characteristics_II_2,axiom,
    iext(uri_rdf_rest,sK3_testcase_premise_fullish_027_Inferred_Property_Characteristics_II_BNODE_l2,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_027_Inferred_Property_Characteristics_II_1,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_027_Inferred_Property_Characteristics_II_BNODE_l1,uri_ex_p) = true ).

cnf(testcase_premise_fullish_027_Inferred_Property_Characteristics_II,axiom,
    iext(uri_rdf_first,sK3_testcase_premise_fullish_027_Inferred_Property_Characteristics_II_BNODE_l2,sK1_testcase_premise_fullish_027_Inferred_Property_Characteristics_II_BNODE_v) = true ).

cnf(testcase_conclusion_fullish_027_Inferred_Property_Characteristics_II,negated_conjecture,
