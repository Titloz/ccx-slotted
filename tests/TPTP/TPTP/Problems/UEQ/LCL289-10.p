%------------------------------------------------------------------------------
% File     : LCL289-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 4.53
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL289-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(equivalent(fnot(and(p,fnot(q))),or(fnot(p),q))) != true ).
