%------------------------------------------------------------------------------
% File     : NLP124-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Comments : Converted from NLP124-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause40,negated_conjecture,
    dirty(skc6,skc8) = true ).

cnf(clause41,negated_conjecture,
    white(skc6,skc8) = true ).

cnf(clause42,negated_conjecture,
    chevy(skc6,skc8) = true ).
...
cnf(clause51,negated_conjecture,
    agent(skc6,skc7,skc8) = true ).

cnf(clause52,negated_conjecture,
    down(skc6,skc7,skc11) = true ).
