%------------------------------------------------------------------------------
% File     : SWB014-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.29 v9.0.0, 0.22 v8.2.0, 0.20 v8.1.0, 0.00 v7.5.0
% Syntax   : Number of clauses     :   99 (  99 unt;   0 nHn;  70 RR)
%            Number of literals    :   99 (  99 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   50 (  50 usr;  42 con; 0-4 aty)
%            Number of variables   :   55 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB014+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_014_Harry_belongs_to_some_Species_7,axiom,
    iext(uri_owl_unionOf,sK2_testcase_premise_fullish_014_Harry_belongs_to_some_Species_BNODE_u,sK3_testcase_premise_fullish_014_Harry_belongs_to_some_Species_BNODE_l1) = true ).

cnf(testcase_premise_fullish_014_Harry_belongs_to_some_Species_6,axiom,
    iext(uri_rdf_rest,sK1_testcase_premise_fullish_014_Harry_belongs_to_some_Species_BNODE_l2,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_014_Harry_belongs_to_some_Species_5,axiom,
    iext(uri_rdf_rest,sK3_testcase_premise_fullish_014_Harry_belongs_to_some_Species_BNODE_l1,sK1_testcase_premise_fullish_014_Harry_belongs_to_some_Species_BNODE_l2) = true ).

cnf(testcase_premise_fullish_014_Harry_belongs_to_some_Species_4,axiom,
    iext(uri_rdf_first,sK1_testcase_premise_fullish_014_Harry_belongs_to_some_Species_BNODE_l2,uri_ex_Falcon) = true ).

cnf(testcase_premise_fullish_014_Harry_belongs_to_some_Species_3,axiom,
    iext(uri_rdf_first,sK3_testcase_premise_fullish_014_Harry_belongs_to_some_Species_BNODE_l1,uri_ex_Eagle) = true ).

cnf(testcase_premise_fullish_014_Harry_belongs_to_some_Species_2,axiom,
    iext(uri_rdf_type,uri_ex_Falcon,uri_ex_Species) = true ).

cnf(testcase_premise_fullish_014_Harry_belongs_to_some_Species_1,axiom,
    iext(uri_rdf_type,uri_ex_Eagle,uri_ex_Species) = true ).

cnf(testcase_premise_fullish_014_Harry_belongs_to_some_Species,axiom,
    iext(uri_rdf_type,uri_ex_harry,sK2_testcase_premise_fullish_014_Harry_belongs_to_some_Species_BNODE_u) = true ).

cnf(testcase_conclusion_fullish_014_Harry_belongs_to_some_Species,negated_conjecture,
    tuple(iext(uri_rdf_type,BNODE_x,uri_ex_Species),iext(uri_rdf_type,uri_ex_harry,BNODE_x)) != tuple(true,true) ).
