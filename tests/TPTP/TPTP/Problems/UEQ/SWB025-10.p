%------------------------------------------------------------------------------
% File     : SWB025-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Syntax   : Number of clauses     :  106 ( 106 unt;   0 nHn;  77 RR)
%            Number of literals    :  106 ( 106 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   56 (  56 usr;  48 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB025+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_14,axiom,
    iext(uri_owl_inverseOf,sK1_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l3,uri_ex_hasFather) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_13,axiom,
    iext(uri_ex_hasFather,uri_ex_bob,uri_ex_charly) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_12,axiom,
    iext(uri_ex_hasFather,uri_ex_alice,uri_ex_dave) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_11,axiom,
    iext(uri_owl_propertyChainAxiom,uri_ex_hasUncle,sK4_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l11) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_10,axiom,
    iext(uri_owl_propertyChainAxiom,uri_ex_hasCousin,sK2_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l21) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_9,axiom,
    iext(uri_rdf_rest,sK2_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l21,sK3_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l22) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_8,axiom,
    iext(uri_rdf_rest,sK3_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l22,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_7,axiom,
    iext(uri_rdf_rest,sK4_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l11,sK5_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l12) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_6,axiom,
    iext(uri_rdf_rest,sK5_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l12,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_5,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l21,uri_ex_hasUncle) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_4,axiom,
    iext(uri_rdf_first,sK3_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l22,sK1_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l3) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_3,axiom,
    iext(uri_rdf_first,sK4_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l11,uri_ex_hasCousin) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_2,axiom,
    iext(uri_rdf_first,sK5_testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_BNODE_l12,uri_ex_hasFather) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties_1,axiom,
    iext(uri_ex_hasUncle,uri_ex_bob,uri_ex_dave) = true ).

cnf(testcase_premise_fullish_025_Cyclic_Dependencies_between_Complex_Properties,axiom,
    iext(uri_ex_hasCousin,uri_ex_alice,uri_ex_bob) = true ).

cnf(testcase_conclusion_fullish_025_Cyclic_Dependencies_between_Complex_Properties,negated_conjecture,
    tuple(iext(uri_ex_hasCousin,uri_ex_bob,uri_ex_alice),iext(uri_ex_hasUncle,uri_ex_alice,uri_ex_charly)) != tuple(true,true) ).
