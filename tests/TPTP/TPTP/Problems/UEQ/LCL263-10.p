%------------------------------------------------------------------------------
% File     : LCL263-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 4.11
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL263-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(equivalent(equivalent(p,q),equivalent(fnot(p),fnot(q)))) != true ).
