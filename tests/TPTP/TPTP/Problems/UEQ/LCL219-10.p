%------------------------------------------------------------------------------
% File     : LCL219-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 2.68
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL219-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(or(fnot(or(fnot(or(fnot(p),q)),q)),or(p,q))) != true ).
