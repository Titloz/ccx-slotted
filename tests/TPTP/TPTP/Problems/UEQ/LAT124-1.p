%------------------------------------------------------------------------------
% File     : LAT124-1 : TPTP v9.0.0. Released v3.1.0.
% Domain   : Lattice Theory
% Problem  : Huntington equation H69 is independent of H32_dual
% Version  : [McC05] (equality) axioms : Especial.
% English  : Show that Huntington equation H32_dual does fnot imply Huntington
...
% Status   : Satisfiable
% Rating   : 0.71 v9.0.0, 0.89 v8.2.0, 0.60 v8.1.0, 0.75 v7.5.0, 0.50 v7.1.0, 0.67 v7.0.0, 0.33 v6.4.0, 0.50 v6.3.0, 0.33 v6.2.0, 0.83 v6.1.0, 0.60 v5.5.0, 0.80 v5.4.0, 0.75 v5.3.0, 0.67 v5.2.0, 0.33 v4.1.0, 0.67 v4.0.1, 0.33 v3.4.0, 0.67 v3.2.0, 1.00 v3.1.0
