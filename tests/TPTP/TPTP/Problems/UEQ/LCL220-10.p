%------------------------------------------------------------------------------
% File     : LCL220-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 2.69
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL220-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(implies(implies(implies(p,q),q),implies(implies(q,p),p))) != true ).
