%------------------------------------------------------------------------------
% File     : LCL252-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 3.44
% Version  : Especial.
% English  :
...
% Status   : Satisfiable
% Rating   : 0.71 v9.0.0, 0.67 v8.2.0, 0.60 v8.1.0, 0.50 v7.5.0
...
% Comments : Converted from LCL252-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(or(fnot(fnot(or(fnot(or(fnot(q),p)),fnot(or(fnot(r),p))))),or(fnot(or(q,r)),p))) != true ).
