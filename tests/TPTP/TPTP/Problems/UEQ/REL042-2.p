%------------------------------------------------------------------------------
% File     : REL042-2 : TPTP v9.0.0. Released v4.0.0.
...
% Rating   : 0.41 v9.0.0, 0.36 v8.2.0, 0.42 v8.1.0, 0.40 v7.5.0, 0.38 v7.4.0, 0.35 v7.3.0, 0.37 v7.1.0, 0.28 v7.0.0, 0.32 v6.4.0, 0.37 v6.3.0, 0.35 v6.2.0, 0.36 v6.1.0, 0.44 v6.0.0, 0.62 v5.5.0, 0.58 v5.4.0, 0.47 v5.3.0, 0.42 v5.2.0, 0.43 v5.1.0, 0.53 v5.0.0, 0.50 v4.1.0, 0.36 v4.0.1, 0.50 v4.0.0
...
% Comments : tptp2X -f tptp:short -t cnf:otter REL042+2.p
%------------------------------------------------------------------------------
...
cnf(goals_17,negated_conjecture,
    meet(composition(sk1,A),composition(sk1,complement(A))) = zero ).
