%------------------------------------------------------------------------------
% File     : SWB032-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.00 v7.3.0
% Syntax   : Number of clauses     :   91 (  91 unt;   0 nHn;  62 RR)
%            Number of literals    :   91 (  91 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   46 (  46 usr;  38 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB032+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_conclusion_fullish_032_Datatype_Relationships,negated_conjecture,
    tuple(iext(uri_rdfs_subClassOf,uri_xsd_integer,uri_xsd_decimal),iext(uri_owl_disjointWith,uri_xsd_decimal,uri_xsd_string)) != tuple(true,true) ).
