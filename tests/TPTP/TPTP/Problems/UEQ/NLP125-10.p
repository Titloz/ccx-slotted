%------------------------------------------------------------------------------
% File     : NLP125-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Comments : Converted from NLP125-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause46,negated_conjecture,
    lonely(skc5,skc8) = true ).

cnf(clause47,negated_conjecture,
    street(skc5,skc8) = true ).
