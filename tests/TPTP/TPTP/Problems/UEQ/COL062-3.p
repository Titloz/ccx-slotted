%--------------------------------------------------------------------------
% File     : COL062-3 : TPTP v9.0.0. Bugfixed v1.2.0.
...
cnf(prove_c_combinator,negated_conjecture,
    apply(apply(apply(apply(apply(b,apply(apply(b,apply(t,apply(apply(b,b),t))),b)),t),x),y),z) != apply(apply(x,z),y) ).
