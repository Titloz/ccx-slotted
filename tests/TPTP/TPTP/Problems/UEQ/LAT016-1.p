%--------------------------------------------------------------------------
% File     : LAT016-1 : TPTP v9.0.0. Bugfixed v2.2.1.
% Domain   : Lattice Theory (Ortholattices)
% Problem  : E1 fails for Ortholattices.
% Version  : [McC98b] (equality) axioms.
% English  : Show that Ortholattices do fnot necessarily satisfy equation E1.
...
% Status   : Satisfiable
% Rating   : 0.43 v9.0.0, 0.44 v8.2.0, 0.40 v8.1.0, 0.25 v7.5.0, 0.00 v6.2.0, 0.33 v6.1.0, 0.40 v5.5.0, 0.60 v5.4.0, 0.50 v5.3.0, 0.67 v5.2.0, 0.33 v2.6.0, 0.67 v2.5.0, 1.00 v2.2.1
