%------------------------------------------------------------------------------
% File     : LCL183-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 2.17
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL183-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(or(fnot(or(fnot(fnot(q)),fnot(p))),or(fnot(p),q))) != true ).
