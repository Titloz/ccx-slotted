%------------------------------------------------------------------------------
% File     : LCL211-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Rating   : 0.32 v9.0.0, 0.36 v8.2.0, 0.38 v8.1.0, 0.35 v7.5.0
...
% Comments : Converted from LCL211-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(implies(fnot(q),implies(or(p,q),p))) != true ).
