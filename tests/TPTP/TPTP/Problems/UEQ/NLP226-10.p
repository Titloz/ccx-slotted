%------------------------------------------------------------------------------
% File     : NLP226-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Vincent believes that every man smokes, problem 7
% Version  : Especial.
% English  :
...
% Comments : Converted from NLP226-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause90,negated_conjecture,
    ifeq2(man(skc12,U),true,smoke(skc12,skf1(V)),true) = true ).

cnf(clause91,negated_conjecture,
    ifeq2(man(skc12,U),true,present(skc12,skf1(V)),true) = true ).

cnf(clause92,negated_conjecture,
    ifeq2(man(skc12,U),true,event(skc12,skf1(V)),true) = true ).

cnf(clause93,negated_conjecture,
    ifeq2(man(skc12,U),true,agent(skc12,skf1(U),U),true) = true ).
