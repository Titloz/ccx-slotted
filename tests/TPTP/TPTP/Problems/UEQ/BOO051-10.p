%------------------------------------------------------------------------------
% File     : BOO051-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Single axiom C12 for Boolean algebra in the Sheffer stroke
% Version  : Especial.
% English  :
...
% Comments : Converted from BOO051-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
cnf(c12,axiom,
    nand(nand(nand(A,nand(A,B)),A),nand(B,nand(A,C))) = B ).
