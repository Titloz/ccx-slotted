%------------------------------------------------------------------------------
% File     : SWB010-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Syntax   : Number of clauses     :   99 (  99 unt;   0 nHn;  70 RR)
%            Number of literals    :   99 (  99 equ;   1 neg)
...
% Comments : Converted from SWB010+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_010_Negative_Property_Assertions_7,axiom,
    iext(uri_owl_oneOf,sK1_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x3,sK2_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x4) = true ).

cnf(testcase_premise_fullish_010_Negative_Property_Assertions_6,axiom,
    iext(uri_owl_complementOf,sK4_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x2,sK1_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x3) = true ).

cnf(testcase_premise_fullish_010_Negative_Property_Assertions_5,axiom,
    iext(uri_owl_allValuesFrom,sK3_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x1,sK4_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x2) = true ).

cnf(testcase_premise_fullish_010_Negative_Property_Assertions_4,axiom,
    iext(uri_owl_onProperty,sK3_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x1,uri_ex_p) = true ).

cnf(testcase_premise_fullish_010_Negative_Property_Assertions_3,axiom,
    iext(uri_rdf_rest,sK2_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x4,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_010_Negative_Property_Assertions_2,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x4,uri_ex_o) = true ).

cnf(testcase_premise_fullish_010_Negative_Property_Assertions_1,axiom,
    iext(uri_rdf_type,uri_ex_p,uri_owl_ObjectProperty) = true ).

cnf(testcase_premise_fullish_010_Negative_Property_Assertions,axiom,
    iext(uri_rdf_type,uri_ex_s,sK3_testcase_premise_fullish_010_Negative_Property_Assertions_BNODE_x1) = true ).

cnf(testcase_conclusion_fullish_010_Negative_Property_Assertions,negated_conjecture,
    tuple(iext(uri_owl_sourceIndividual,BNODE_z,uri_ex_s),iext(uri_rdf_type,BNODE_z,uri_owl_NegativePropertyAssertion),iext(uri_owl_assertionProperty,BNODE_z,uri_ex_p),iext(uri_owl_targetIndividual,BNODE_z,uri_ex_o)) != tuple(true,true,true,true) ).
