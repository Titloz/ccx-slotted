%--------------------------------------------------------------------------
% File     : LCL115-2 : TPTP v9.0.0. Released v1.0.0.
...
% Rating   : 0.14 v8.2.0, 0.17 v8.1.0, 0.20 v7.5.0, 0.17 v7.4.0, 0.26 v7.3.0, 0.21 v7.1.0, 0.11 v6.4.0, 0.16 v6.3.0, 0.18 v6.2.0, 0.14 v6.1.0, 0.06 v6.0.0, 0.29 v5.5.0, 0.26 v5.4.0, 0.07 v5.3.0, 0.00 v5.2.0, 0.07 v5.0.0, 0.00 v2.2.1, 0.22 v2.2.0, 0.29 v2.1.0, 0.25 v2.0.0
...
cnf(prove_mv_39,negated_conjecture,
    implies(fnot(implies(a,b)),fnot(b)) != truth ).
