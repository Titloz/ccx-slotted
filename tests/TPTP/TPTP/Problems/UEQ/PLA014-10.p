%------------------------------------------------------------------------------
% File     : PLA014-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Comments : Converted from PLA014-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_ABC,negated_conjecture,
    holds(and(on(a,b),on(b,c)),State) != true ).
