%------------------------------------------------------------------------------
% File     : LAT229-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Equation H17 is Huntington by implication
% Version  : Especial.
% English  :
...
% Comments : Converted from LAT229-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(equation_H17,axiom,
    meet(X,join(meet(X,Y),meet(X,Z))) = meet(X,join(meet(Y,join(X,meet(Y,Z))),meet(Z,join(X,Y)))) ).
