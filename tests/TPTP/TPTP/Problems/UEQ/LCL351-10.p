%------------------------------------------------------------------------------
% File     : LCL351-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Comments : Converted from LCL351-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(implies(implies(q,fnot(r)),equivalent(and(or(p,q),r),and(p,r)))) != true ).
