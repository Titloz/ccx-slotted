%------------------------------------------------------------------------------
% File     : NLP247-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.43 v9.0.0, 0.22 v8.2.0, 0.20 v8.1.0, 0.25 v7.5.0, 0.50 v7.3.0
...
% Comments : Converted from NLP247-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause76,negated_conjecture,
    event(skc15,skc25) = true ).

cnf(clause77,negated_conjecture,
    man(skc14,skc24) = true ).

cnf(clause78,negated_conjecture,
    present(skc15,skc25) = true ).

cnf(clause79,negated_conjecture,
    smoke(skc15,skc25) = true ).
...
cnf(clause82,negated_conjecture,
    man(skc14,skc20) = true ).

cnf(clause83,negated_conjecture,
    vincent_forename(skc14,skc19) = true ).

cnf(clause84,negated_conjecture,
    forename(skc14,skc19) = true ).

cnf(clause85,negated_conjecture,
    think_believe_consider(skc14,skc18) = true ).

cnf(clause86,negated_conjecture,
    present(skc14,skc18) = true ).

cnf(clause87,negated_conjecture,
    event(skc14,skc18) = true ).
...
cnf(clause91,negated_conjecture,
    proposition(skc14,skc17) = true ).

cnf(clause92,negated_conjecture,
    accessible_world(skc14,skc17) = true ).
...
cnf(clause99,negated_conjecture,
    of(skc14,skc23,skc24) = true ).

cnf(clause100,negated_conjecture,
    agent(skc15,skc25,skc24) = true ).

cnf(clause101,negated_conjecture,
    of(skc14,skc21,skc20) = true ).

cnf(clause102,negated_conjecture,
    agent(skc14,skc16,skc20) = true ).

cnf(clause103,negated_conjecture,
    agent(skc14,skc18,skc20) = true ).

cnf(clause104,negated_conjecture,
    of(skc14,skc19,skc20) = true ).

cnf(clause105,negated_conjecture,
    theme(skc14,skc18,skc17) = true ).
...
cnf(clause108,negated_conjecture,
    ifeq2(man(skc17,U),true,smoke(skc17,skf1(V)),true) = true ).

cnf(clause109,negated_conjecture,
    ifeq2(man(skc17,U),true,present(skc17,skf1(V)),true) = true ).

cnf(clause110,negated_conjecture,
    ifeq2(man(skc17,U),true,event(skc17,skf1(V)),true) = true ).

cnf(clause111,negated_conjecture,
    ifeq2(man(skc17,U),true,agent(skc17,skf1(U),U),true) = true ).
