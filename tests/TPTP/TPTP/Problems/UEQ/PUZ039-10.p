%------------------------------------------------------------------------------
% File     : PUZ039-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Quo vadis 2
% Version  : Especial.
% English  :
...
% Rating   : 0.32 v9.0.0, 0.27 v8.2.0, 0.25 v8.1.0, 0.35 v7.5.0
...
% Comments : Converted from PUZ039-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(goal_state,negated_conjecture,
    state(B,V1,V2,V3,v4(s(s(o)),s(s(o))),H,S1,S2,S3,S4,E1,E2) != true ).
