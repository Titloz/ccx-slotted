%------------------------------------------------------------------------------
% File     : SWB018-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Syntax   : Number of clauses     :   93 (  93 unt;   0 nHn;  64 RR)
%            Number of literals    :   93 (  93 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   45 (  45 usr;  38 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB018+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_018_Modified_Logical_Vocabulary_Semantics_1,axiom,
    iext(uri_rdfs_domain,uri_owl_sameAs,uri_ex_Person) = true ).

cnf(testcase_premise_fullish_018_Modified_Logical_Vocabulary_Semantics,axiom,
    iext(uri_owl_sameAs,uri_ex_w,uri_ex_u) = true ).

cnf(testcase_conclusion_fullish_018_Modified_Logical_Vocabulary_Semantics,negated_conjecture,
    iext(uri_rdf_type,uri_ex_u,uri_ex_Person) != true ).
