%--------------------------------------------------------------------------
% File     : COL003-12 : TPTP v9.0.0. Released v2.1.0.
...
% Rating   : 0.18 v9.0.0, 0.14 v8.2.0, 0.21 v8.1.0, 0.20 v7.5.0, 0.21 v7.4.0, 0.30 v7.3.0, 0.21 v7.1.0, 0.11 v7.0.0, 0.16 v6.4.0, 0.21 v6.3.0, 0.24 v6.2.0, 0.21 v6.1.0, 0.25 v6.0.0, 0.29 v5.5.0, 0.32 v5.4.0, 0.27 v5.3.0, 0.17 v5.2.0, 0.14 v5.1.0, 0.13 v5.0.0, 0.21 v4.1.0, 0.09 v4.0.1, 0.07 v4.0.0, 0.08 v3.7.0, 0.22 v3.4.0, 0.25 v3.3.0, 0.07 v3.1.0, 0.22 v2.7.0, 0.18 v2.6.0, 0.17 v2.5.0, 0.00 v2.2.1, 0.25 v2.2.0, 0.40 v2.1.0
...
cnf(strong_fixed_point,axiom,
    strong_fixed_point = apply(apply(b,apply(w,w)),apply(apply(b,w),apply(apply(b,b),b))) ).
