%------------------------------------------------------------------------------
% File     : NLP128-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : An old dirty white Chevy, problem 15
% Version  : Especial.
% English  :
...
% Comments : Converted from NLP128-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause37,negated_conjecture,
    hollywood_placename(skc5,skc9) = true ).

cnf(clause38,negated_conjecture,
    placename(skc5,skc9) = true ).
...
cnf(clause45,negated_conjecture,
    dirty(skc5,skc8) = true ).

cnf(clause46,negated_conjecture,
    white(skc5,skc8) = true ).

cnf(clause47,negated_conjecture,
    chevy(skc5,skc8) = true ).

cnf(clause48,negated_conjecture,
    city(skc5,skc8) = true ).

cnf(clause49,negated_conjecture,
    of(skc5,skc9,skc8) = true ).

cnf(clause50,negated_conjecture,
    down(skc5,skc6,skc7) = true ).

cnf(clause51,negated_conjecture,
    in(skc5,skc6,skc8) = true ).

cnf(clause52,negated_conjecture,
    agent(skc5,skc6,skc8) = true ).
