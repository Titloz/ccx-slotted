%------------------------------------------------------------------------------
% File     : LCL224-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Comments : Converted from LCL224-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(implies(or(p,implies(q,r)),implies(or(p,q),or(p,r)))) != true ).
