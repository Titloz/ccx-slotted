%------------------------------------------------------------------------------
% File     : LCL113-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : MV-33 depnds on the Merideth system
% Version  : Especial.
% English  :
...
% Rating   : 0.59 v9.0.0, 0.55 v8.2.0, 0.58 v8.1.0, 0.50 v7.5.0, 0.58 v7.4.0, 0.65 v7.3.0
...
cnf(mv_5,axiom,
    is_a_theorem(implies(implies(fnot(X),fnot(Y)),implies(Y,X))) = true ).

cnf(prove_mv_33,negated_conjecture,
    is_a_theorem(implies(implies(fnot(a),b),implies(fnot(b),a))) != true ).
