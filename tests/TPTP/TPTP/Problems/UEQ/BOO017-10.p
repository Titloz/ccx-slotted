%------------------------------------------------------------------------------
% File     : BOO017-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Rating   : 0.36 v8.2.0, 0.33 v8.1.0, 0.35 v7.5.0
% Syntax   : Number of clauses     :   26 (  26 unt;   0 nHn;   2 RR)
%            Number of literals    :   26 (  26 equ;   1 neg)
...
% Comments : Converted from BOO017-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
