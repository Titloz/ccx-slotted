%------------------------------------------------------------------------------
% File     : GRP689-1 : TPTP v9.0.0. Released v4.0.0.
% Domain   : Group Theory (Quasigroups)
% Problem  : Bruck loop elements of order 2^2 commute with elems of order 3^2
% Version  : Especial.
% English  :
...
% Rating   : 0.68 v8.2.0, 0.71 v8.1.0, 0.85 v7.5.0, 0.79 v7.4.0, 0.78 v7.3.0, 0.79 v7.1.0, 0.72 v7.0.0, 0.74 v6.3.0, 0.71 v6.1.0, 0.75 v6.0.0, 0.86 v5.5.0, 0.84 v5.4.0, 0.73 v5.3.0, 0.58 v5.2.0, 0.64 v5.1.0, 0.67 v5.0.0, 0.64 v4.1.0, 0.55 v4.0.1, 0.79 v4.0.0
