%------------------------------------------------------------------------------
% File     : SWB023-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.00 v7.5.0
% Syntax   : Number of clauses     :   98 (  98 unt;   0 nHn;  69 RR)
%            Number of literals    :   98 (  98 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   51 (  51 usr;  43 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB023+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_023_Unique_List_Components_6,axiom,
    iext(uri_owl_oneOf,sK1_testcase_premise_fullish_023_Unique_List_Components_BNODE_o,sK2_testcase_premise_fullish_023_Unique_List_Components_BNODE_l) = true ).

cnf(testcase_premise_fullish_023_Unique_List_Components_5,axiom,
    iext(uri_rdf_rest,sK2_testcase_premise_fullish_023_Unique_List_Components_BNODE_l,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_023_Unique_List_Components_4,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_023_Unique_List_Components_BNODE_l,uri_ex_u) = true ).

cnf(testcase_premise_fullish_023_Unique_List_Components_3,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_023_Unique_List_Components_BNODE_l,uri_ex_v) = true ).

cnf(testcase_premise_fullish_023_Unique_List_Components_2,axiom,
    iext(uri_rdf_type,sK1_testcase_premise_fullish_023_Unique_List_Components_BNODE_o,uri_owl_Class) = true ).

cnf(testcase_premise_fullish_023_Unique_List_Components_1,axiom,
    iext(uri_rdf_type,uri_rdf_first,uri_owl_FunctionalProperty) = true ).

cnf(testcase_premise_fullish_023_Unique_List_Components,axiom,
    iext(uri_rdf_type,uri_ex_w,sK1_testcase_premise_fullish_023_Unique_List_Components_BNODE_o) = true ).

cnf(testcase_conclusion_fullish_023_Unique_List_Components,negated_conjecture,
    tuple(iext(uri_owl_sameAs,uri_ex_w,uri_ex_v),iext(uri_owl_sameAs,uri_ex_w,uri_ex_u)) != tuple(true,true) ).
