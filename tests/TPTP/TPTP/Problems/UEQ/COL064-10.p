%--------------------------------------------------------------------------
% File     : COL064-10 : TPTP v9.0.0. Bugfixed v1.2.0.
...
% Rating   : 0.14 v9.0.0, 0.09 v8.2.0, 0.17 v8.1.0, 0.20 v7.5.0, 0.17 v7.4.0, 0.22 v7.3.0, 0.16 v7.1.0, 0.06 v7.0.0, 0.16 v6.4.0, 0.21 v6.3.0, 0.18 v6.2.0, 0.21 v6.1.0, 0.12 v6.0.0, 0.24 v5.5.0, 0.26 v5.4.0, 0.07 v5.3.0, 0.08 v5.2.0, 0.14 v5.1.0, 0.13 v5.0.0, 0.14 v4.1.0, 0.18 v4.0.1, 0.14 v4.0.0, 0.15 v3.7.0, 0.11 v3.4.0, 0.12 v3.3.0, 0.07 v3.1.0, 0.11 v2.7.0, 0.00 v2.2.1, 0.22 v2.2.0, 0.29 v2.1.0, 0.71 v2.0.0
...
cnf(prove_v_combinator,negated_conjecture,
    apply(apply(apply(apply(apply(b,apply(apply(b,apply(t,apply(apply(b,b),t))),apply(apply(b,b),t))),t),x),y),z) != apply(apply(z,x),y) ).
