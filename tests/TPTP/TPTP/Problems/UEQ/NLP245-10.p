%------------------------------------------------------------------------------
% File     : NLP245-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Vincent believes that every man smokes, problem 26
% Version  : Especial.
% English  :
...
% Comments : Converted from NLP245-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause74,negated_conjecture,
    forename(skc13,skc24) = true ).

cnf(clause75,negated_conjecture,
    vincent_forename(skc13,skc24) = true ).

cnf(clause76,negated_conjecture,
    event(skc13,skc23) = true ).

cnf(clause77,negated_conjecture,
    present(skc13,skc23) = true ).

cnf(clause78,negated_conjecture,
    think_believe_consider(skc13,skc23) = true ).

cnf(clause79,negated_conjecture,
    forename(skc13,skc21) = true ).
...
cnf(clause83,negated_conjecture,
    jules_forename(skc13,skc19) = true ).
...
cnf(clause86,negated_conjecture,
    smoke(skc14,skc20) = true ).

cnf(clause87,negated_conjecture,
    man(skc13,skc17) = true ).

cnf(clause88,negated_conjecture,
    vincent_forename(skc13,skc21) = true ).
...
cnf(clause95,negated_conjecture,
    accessible_world(skc13,skc22) = true ).

cnf(clause96,negated_conjecture,
    proposition(skc13,skc22) = true ).

cnf(clause97,negated_conjecture,
    of(skc13,skc24,skc25) = true ).

cnf(clause98,negated_conjecture,
    agent(skc13,skc23,skc25) = true ).

cnf(clause99,negated_conjecture,
    theme(skc13,skc23,skc22) = true ).
...
cnf(clause102,negated_conjecture,
    agent(skc14,skc20,skc17) = true ).

cnf(clause103,negated_conjecture,
    agent(skc13,skc15,skc17) = true ).

cnf(clause104,negated_conjecture,
    of(skc13,skc21,skc17) = true ).
...
cnf(clause107,negated_conjecture,
    ifeq2(man(skc22,U),true,smoke(skc22,skf1(V)),true) = true ).

cnf(clause108,negated_conjecture,
    ifeq2(man(skc22,U),true,present(skc22,skf1(V)),true) = true ).

cnf(clause109,negated_conjecture,
    ifeq2(man(skc22,U),true,event(skc22,skf1(V)),true) = true ).

cnf(clause110,negated_conjecture,
    ifeq2(man(skc22,U),true,agent(skc22,skf1(U),U),true) = true ).
