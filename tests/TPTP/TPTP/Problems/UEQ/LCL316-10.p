%------------------------------------------------------------------------------
% File     : LCL316-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 4.85
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL316-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(implies(equivalent(p,q),equivalent(implies(r,p),implies(r,q)))) != true ).
