%------------------------------------------------------------------------------
% File     : LAT206-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Equation H60 is Huntington by distributivity
% Version  : Especial.
% English  :
...
% Rating   : 0.91 v9.0.0, 0.95 v8.2.0, 0.96 v8.1.0, 0.95 v7.5.0
...
% Comments : Converted from LAT206-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
