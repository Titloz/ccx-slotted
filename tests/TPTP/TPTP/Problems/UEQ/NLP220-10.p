%------------------------------------------------------------------------------
% File     : NLP220-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.43 v9.0.0, 0.11 v8.2.0, 0.20 v8.1.0, 0.00 v7.5.0, 0.50 v7.3.0
% Syntax   : Number of clauses     :   84 (  84 unt;   0 nHn;  13 RR)
%            Number of literals    :   84 (  84 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :   10 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   46 (  46 usr;   8 con; 0-4 aty)
%            Number of variables   :  184 (   9 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from NLP220-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause77,negated_conjecture,
    ifeq2(man(skc6,U),true,smoke(skc6,skf1(V)),true) = true ).

cnf(clause78,negated_conjecture,
    ifeq2(man(skc6,U),true,present(skc6,skf1(V)),true) = true ).

cnf(clause79,negated_conjecture,
    ifeq2(man(skc6,U),true,event(skc6,skf1(V)),true) = true ).

cnf(clause80,negated_conjecture,
    ifeq2(man(skc6,U),true,agent(skc6,skf1(U),U),true) = true ).
