%------------------------------------------------------------------------------
% File     : SWB028-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Comments : Converted from SWB028+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_028_Inferred_Property_Characteristics_III_3,axiom,
    iext(uri_owl_someValuesFrom,sK1_testcase_premise_fullish_028_Inferred_Property_Characteristics_III_BNODE_z,uri_owl_FunctionalProperty) = true ).

cnf(testcase_premise_fullish_028_Inferred_Property_Characteristics_III_2,axiom,
    iext(uri_owl_onProperty,sK1_testcase_premise_fullish_028_Inferred_Property_Characteristics_III_BNODE_z,uri_owl_inverseOf) = true ).

cnf(testcase_premise_fullish_028_Inferred_Property_Characteristics_III_1,axiom,
    iext(uri_owl_equivalentClass,uri_ex_InversesOfFunctionalProperties,sK1_testcase_premise_fullish_028_Inferred_Property_Characteristics_III_BNODE_z) = true ).

cnf(testcase_premise_fullish_028_Inferred_Property_Characteristics_III,axiom,
    iext(uri_rdf_type,sK1_testcase_premise_fullish_028_Inferred_Property_Characteristics_III_BNODE_z,uri_owl_Restriction) = true ).

cnf(testcase_conclusion_fullish_028_Inferred_Property_Characteristics_III,negated_conjecture,
    iext(uri_rdfs_subClassOf,uri_ex_InversesOfFunctionalProperties,uri_owl_InverseFunctionalProperty) != true ).
