%------------------------------------------------------------------------------
% File     : SWB017-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
%            Number of functors    :   47 (  47 usr;  40 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB017+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_017_Built_in_Based_Definitions_2,axiom,
    iext(uri_ex_fnotInstanceOf,uri_ex_u,uri_ex_c) = true ).

cnf(testcase_premise_fullish_017_Built_in_Based_Definitions_1,axiom,
    iext(uri_owl_propertyDisjointWith,uri_ex_fnotInstanceOf,uri_rdf_type) = true ).

cnf(testcase_premise_fullish_017_Built_in_Based_Definitions,axiom,
    iext(uri_rdf_type,uri_ex_w,uri_ex_c) = true ).

cnf(testcase_conclusion_fullish_017_Built_in_Based_Definitions,negated_conjecture,
    iext(uri_owl_differentFrom,uri_ex_w,uri_ex_u) != true ).
