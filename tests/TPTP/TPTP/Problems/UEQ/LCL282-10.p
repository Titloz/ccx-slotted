%------------------------------------------------------------------------------
% File     : LCL282-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 4.41
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL282-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(equivalent(or(p,and(q,r)),and(or(p,q),or(p,r)))) != true ).
