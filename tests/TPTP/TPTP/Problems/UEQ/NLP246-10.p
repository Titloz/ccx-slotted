%------------------------------------------------------------------------------
% File     : NLP246-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Vincent believes that every man smokes, problem 27
% Version  : Especial.
% English  :
...
% Status   : Satisfiable
% Rating   : 0.29 v9.0.0, 0.11 v8.2.0, 0.20 v8.1.0, 0.25 v7.5.0
...
% Comments : Converted from NLP246-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause73,negated_conjecture,
    event(skc14,skc24) = true ).

cnf(clause74,negated_conjecture,
    man(skc13,skc23) = true ).

cnf(clause75,negated_conjecture,
    present(skc14,skc24) = true ).

cnf(clause76,negated_conjecture,
    smoke(skc14,skc24) = true ).

cnf(clause77,negated_conjecture,
    jules_forename(skc13,skc25) = true ).

cnf(clause78,negated_conjecture,
    forename(skc13,skc25) = true ).

cnf(clause79,negated_conjecture,
    forename(skc13,skc22) = true ).

cnf(clause80,negated_conjecture,
    vincent_forename(skc13,skc22) = true ).

cnf(clause81,negated_conjecture,
    event(skc13,skc21) = true ).

cnf(clause82,negated_conjecture,
    present(skc13,skc21) = true ).

cnf(clause83,negated_conjecture,
    think_believe_consider(skc13,skc21) = true ).

cnf(clause84,negated_conjecture,
    forename(skc13,skc19) = true ).

cnf(clause85,negated_conjecture,
    jules_forename(skc13,skc18) = true ).

cnf(clause86,negated_conjecture,
    forename(skc13,skc18) = true ).

cnf(clause87,negated_conjecture,
    man(skc13,skc17) = true ).

cnf(clause88,negated_conjecture,
    vincent_forename(skc13,skc19) = true ).

cnf(clause89,negated_conjecture,
    state(skc13,skc16) = true ).
...
cnf(clause93,negated_conjecture,
    accessible_world(skc13,skc20) = true ).

cnf(clause94,negated_conjecture,
    proposition(skc13,skc20) = true ).
...
cnf(clause97,negated_conjecture,
    of(skc13,skc25,skc23) = true ).

cnf(clause98,negated_conjecture,
    of(skc13,skc22,skc23) = true ).

cnf(clause99,negated_conjecture,
    agent(skc13,skc21,skc23) = true ).

cnf(clause100,negated_conjecture,
    agent(skc14,skc24,skc23) = true ).

cnf(clause101,negated_conjecture,
    theme(skc13,skc21,skc20) = true ).

cnf(clause102,negated_conjecture,
    of(skc13,skc18,skc17) = true ).

cnf(clause103,negated_conjecture,
    agent(skc13,skc15,skc17) = true ).

cnf(clause104,negated_conjecture,
    of(skc13,skc19,skc17) = true ).

cnf(clause105,negated_conjecture,
    theme(skc13,skc15,skc14) = true ).

cnf(clause106,negated_conjecture,
    be(skc13,skc16,skc17,skc17) = true ).

cnf(clause107,negated_conjecture,
    ifeq2(man(skc20,U),true,smoke(skc20,skf1(V)),true) = true ).

cnf(clause108,negated_conjecture,
    ifeq2(man(skc20,U),true,present(skc20,skf1(V)),true) = true ).

cnf(clause109,negated_conjecture,
    ifeq2(man(skc20,U),true,event(skc20,skf1(V)),true) = true ).

cnf(clause110,negated_conjecture,
    ifeq2(man(skc20,U),true,agent(skc20,skf1(U),U),true) = true ).
