%------------------------------------------------------------------------------
% File     : GRP677-1 : TPTP v9.0.0. Released v4.0.0.
% Domain   : Group Theory (Quasigroups)
% Problem  : In CC-loops, associators are in the center of the nucleus - 1c
% Version  : Especial.
% English  :
...
cnf(goals,negated_conjecture,
    mult(a,mult(b,asoc(c,d,e))) != mult(mult(a,b),asoc(c,d,e)) ).
