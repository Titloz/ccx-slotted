%------------------------------------------------------------------------------
% File     : SWB005-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Syntax   : Number of clauses     :   92 (  92 unt;   0 nHn;  63 RR)
%            Number of literals    :   92 (  92 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   47 (  47 usr;  39 con; 0-8 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB005+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_005_Everything_is_a_Resource,axiom,
    iext(uri_ex_p,uri_ex_s,uri_ex_o) = true ).

cnf(testcase_conclusion_fullish_005_Everything_is_a_Resource,negated_conjecture,
    tuple(iext(uri_rdf_type,uri_ex_s,uri_owl_Thing),iext(uri_rdf_type,uri_ex_s,uri_rdfs_Resource),iext(uri_rdf_type,uri_ex_p,uri_owl_Thing),iext(uri_rdf_type,uri_ex_p,uri_rdfs_Resource),iext(uri_rdf_type,uri_ex_p,uri_rdf_Property),iext(uri_rdf_type,uri_ex_p,uri_owl_ObjectProperty),iext(uri_rdf_type,uri_ex_o,uri_owl_Thing),iext(uri_rdf_type,uri_ex_o,uri_rdfs_Resource)) != tuple(true,true,true,true,true,true,true,true) ).
