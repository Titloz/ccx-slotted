%------------------------------------------------------------------------------
% File     : LCL245-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 3.34
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL245-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(implies(and(implies(q,r),implies(p,q)),implies(p,r))) != true ).
