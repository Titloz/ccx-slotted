%------------------------------------------------------------------------------
% File     : SWB026-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
%            Number of functors    :   50 (  50 usr;  43 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB026+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_026_Inferred_Property_Characteristics_I_7,axiom,
    iext(uri_owl_oneOf,sK1_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_x2,sK2_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_l2) = true ).

cnf(testcase_premise_fullish_026_Inferred_Property_Characteristics_I_6,axiom,
    iext(uri_owl_oneOf,sK3_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_x1,sK4_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_l1) = true ).

cnf(testcase_premise_fullish_026_Inferred_Property_Characteristics_I_5,axiom,
    iext(uri_rdfs_range,uri_ex_p,sK1_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_x2) = true ).

cnf(testcase_premise_fullish_026_Inferred_Property_Characteristics_I_4,axiom,
    iext(uri_rdfs_domain,uri_ex_p,sK3_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_x1) = true ).

cnf(testcase_premise_fullish_026_Inferred_Property_Characteristics_I_3,axiom,
    iext(uri_rdf_rest,sK2_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_l2,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_026_Inferred_Property_Characteristics_I_2,axiom,
    iext(uri_rdf_rest,sK4_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_l1,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_026_Inferred_Property_Characteristics_I_1,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_l2,uri_ex_u) = true ).

cnf(testcase_premise_fullish_026_Inferred_Property_Characteristics_I,axiom,
    iext(uri_rdf_first,sK4_testcase_premise_fullish_026_Inferred_Property_Characteristics_I_BNODE_l1,uri_ex_w) = true ).

cnf(testcase_conclusion_fullish_026_Inferred_Property_Characteristics_I,negated_conjecture,
    iext(uri_rdf_type,uri_ex_p,uri_owl_InverseFunctionalProperty) != true ).
