%------------------------------------------------------------------------------
% File     : SWB024-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.29 v9.0.0, 0.11 v8.2.0, 0.20 v8.1.0, 0.00 v7.5.0, 0.25 v7.3.0
% Syntax   : Number of clauses     :   99 (  99 unt;   0 nHn;  70 RR)
%            Number of literals    :   99 (  99 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   54 (  54 usr;  45 con; 0-4 aty)
%            Number of variables   :   55 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB024+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_7,axiom,
    iext(uri_owl_minCardinality,sK1_testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_BNODE_z,literal_typed(dat_str_1,uri_xsd_nonNegativeInteger)) = true ).

cnf(testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_6,axiom,
    iext(uri_owl_onProperty,sK1_testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_BNODE_z,uri_ex_hasAncestor) = true ).

cnf(testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_5,axiom,
    iext(uri_rdf_type,sK1_testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_BNODE_z,uri_owl_Restriction) = true ).

cnf(testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_4,axiom,
    iext(uri_rdf_type,uri_ex_bob,uri_ex_Person) = true ).

cnf(testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_3,axiom,
    iext(uri_rdf_type,uri_ex_alice,uri_ex_Person) = true ).

cnf(testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_2,axiom,
    iext(uri_rdf_type,uri_ex_hasAncestor,uri_owl_TransitiveProperty) = true ).

cnf(testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_1,axiom,
    iext(uri_ex_hasAncestor,uri_ex_alice,uri_ex_bob) = true ).

cnf(testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties,axiom,
    iext(uri_rdfs_subClassOf,uri_ex_Person,sK1_testcase_premise_fullish_024_Cardinality_Restrictions_on_Complex_Properties_BNODE_z) = true ).

cnf(testcase_conclusion_fullish_024_Cardinality_Restrictions_on_Complex_Properties,negated_conjecture,
    tuple(iext(uri_ex_hasAncestor,uri_ex_alice,BNODE_x),iext(uri_ex_hasAncestor,uri_ex_bob,BNODE_x)) != tuple(true,true) ).
