%--------------------------------------------------------------------------
% File     : COL059-1 : TPTP v9.0.0. Released v1.0.0.
% Domain   : Combinatory Logic
% Problem  : L3 ((lark lark) lark) is fnot egocentric.
% Version  : Especial.
% English  :
...
cnf(lark_fnot_egocentric,axiom,
    response(l2,l2) != l2 ).
...
cnf(prove_l3_fnot_egocentric,negated_conjecture,
    response(l3,l3) = l3 ).
