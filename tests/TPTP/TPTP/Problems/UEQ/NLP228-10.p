%------------------------------------------------------------------------------
% File     : NLP228-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.43 v9.0.0, 0.33 v8.2.0, 0.60 v8.1.0, 0.50 v7.5.0
...
% Comments : Converted from NLP228-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause88,negated_conjecture,
    ifeq3(actual_world(U),true,ifeq3(be(U,V,X1,W),true,ifeq3(theme(U,Y,X),true,ifeq3(agent(U,Y,X1),true,ifeq3(of(U,X2,X1),true,ifeq3(of(U,Z,X1),true,ifeq3(think_believe_consider(U,Y),true,ifeq3(present(U,Y),true,ifeq3(accessible_world(U,X),true,ifeq3(vincent_forename(U,Z),true,ifeq3(proposition(U,X),true,ifeq3(jules_forename(U,X2),true,ifeq3(forename(U,X2),true,ifeq3(forename(U,Z),true,ifeq3(man(U,X1),true,ifeq3(man(U,W),true,ifeq3(event(U,Y),true,ifeq3(state(U,V),true,man(X,skf4(X)),true),true),true),true),true),true),true),true),true),true),true),true),true),true),true),true),true),true) = true ).
...
cnf(clause89,negated_conjecture,
    ifeq(tuple(state(U,V),event(U,Z),event(X,Y),man(U,W),man(U,X2),forename(U,X1),forename(U,X3),jules_forename(U,X3),smoke(X,Y),proposition(U,X),vincent_forename(U,X1),accessible_world(U,X),present(U,Z),present(X,Y),think_believe_consider(U,Z),of(U,X1,X2),of(U,X3,X2),agent(U,Z,X2),agent(X,Y,skf4(X)),theme(U,Z,X),be(U,V,X2,W),actual_world(U)),tuple(true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true),a,b) = b ).
