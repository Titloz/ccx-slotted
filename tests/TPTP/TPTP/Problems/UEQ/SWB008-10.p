%------------------------------------------------------------------------------
% File     : SWB008-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
%            Number of functors    :   49 (  49 usr;  41 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB008+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_008_Inverse_Functional_Data_Properties_3,axiom,
    iext(uri_foaf_mbox_sha1sum,uri_ex_robert,literal_plain(dat_str_xyz)) = true ).

cnf(testcase_premise_fullish_008_Inverse_Functional_Data_Properties_2,axiom,
    iext(uri_foaf_mbox_sha1sum,uri_ex_bob,literal_plain(dat_str_xyz)) = true ).

cnf(testcase_premise_fullish_008_Inverse_Functional_Data_Properties_1,axiom,
    iext(uri_rdf_type,uri_foaf_mbox_sha1sum,uri_owl_DatatypeProperty) = true ).

cnf(testcase_premise_fullish_008_Inverse_Functional_Data_Properties,axiom,
    iext(uri_rdf_type,uri_foaf_mbox_sha1sum,uri_owl_InverseFunctionalProperty) = true ).

cnf(testcase_conclusion_fullish_008_Inverse_Functional_Data_Properties,negated_conjecture,
    iext(uri_owl_sameAs,uri_ex_bob,uri_ex_robert) != true ).
