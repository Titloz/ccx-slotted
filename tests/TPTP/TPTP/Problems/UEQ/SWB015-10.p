%------------------------------------------------------------------------------
% File     : SWB015-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Comments : Converted from SWB015+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_conclusion_fullish_015_Reflective_Tautologies_I,negated_conjecture,
    iext(uri_owl_sameAs,uri_owl_sameAs,uri_owl_sameAs) != true ).
