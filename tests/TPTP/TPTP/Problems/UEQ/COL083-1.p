%--------------------------------------------------------------------------
% File     : COL083-1 : TPTP v9.0.0. Released v2.6.0.
...
% Rating   : 0.00 v7.4.0, 0.04 v7.3.0, 0.00 v6.0.0, 0.05 v5.5.0, 0.00 v2.6.0
...
cnf(prove_birds_are_compatible_1,negated_conjecture,
    response(a,A) != B ).
