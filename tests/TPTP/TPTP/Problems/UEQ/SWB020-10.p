%------------------------------------------------------------------------------
% File     : SWB020-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
%            Number of functors    :   57 (  57 usr;  50 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB020+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_020_Logical_Complications_14,axiom,
    iext(uri_owl_complementOf,sK4_testcase_premise_fullish_020_Logical_Complications_BNODE_xc,uri_ex_c2) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_13,axiom,
    iext(uri_owl_intersectionOf,sK6_testcase_premise_fullish_020_Logical_Complications_BNODE_xs,sK7_testcase_premise_fullish_020_Logical_Complications_BNODE_li1) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_12,axiom,
    iext(uri_owl_disjointWith,uri_ex_d,uri_ex_c1) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_11,axiom,
    iext(uri_owl_unionOf,uri_ex_c,sK2_testcase_premise_fullish_020_Logical_Complications_BNODE_lu1) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_10,axiom,
    iext(uri_rdf_rest,sK1_testcase_premise_fullish_020_Logical_Complications_BNODE_lu3,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_9,axiom,
    iext(uri_rdf_rest,sK2_testcase_premise_fullish_020_Logical_Complications_BNODE_lu1,sK3_testcase_premise_fullish_020_Logical_Complications_BNODE_lu2) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_8,axiom,
    iext(uri_rdf_rest,sK3_testcase_premise_fullish_020_Logical_Complications_BNODE_lu2,sK1_testcase_premise_fullish_020_Logical_Complications_BNODE_lu3) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_7,axiom,
    iext(uri_rdf_rest,sK5_testcase_premise_fullish_020_Logical_Complications_BNODE_li2,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_6,axiom,
    iext(uri_rdf_rest,sK7_testcase_premise_fullish_020_Logical_Complications_BNODE_li1,sK5_testcase_premise_fullish_020_Logical_Complications_BNODE_li2) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_5,axiom,
    iext(uri_rdf_first,sK1_testcase_premise_fullish_020_Logical_Complications_BNODE_lu3,uri_ex_c3) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_4,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_020_Logical_Complications_BNODE_lu1,uri_ex_c1) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_3,axiom,
    iext(uri_rdf_first,sK3_testcase_premise_fullish_020_Logical_Complications_BNODE_lu2,uri_ex_c2) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_2,axiom,
    iext(uri_rdf_first,sK5_testcase_premise_fullish_020_Logical_Complications_BNODE_li2,sK4_testcase_premise_fullish_020_Logical_Complications_BNODE_xc) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications_1,axiom,
    iext(uri_rdf_first,sK7_testcase_premise_fullish_020_Logical_Complications_BNODE_li1,uri_ex_c) = true ).

cnf(testcase_premise_fullish_020_Logical_Complications,axiom,
    iext(uri_rdfs_subClassOf,uri_ex_d,sK6_testcase_premise_fullish_020_Logical_Complications_BNODE_xs) = true ).

cnf(testcase_conclusion_fullish_020_Logical_Complications,negated_conjecture,
    iext(uri_rdfs_subClassOf,uri_ex_d,uri_ex_c3) != true ).
