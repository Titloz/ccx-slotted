%------------------------------------------------------------------------------
% File     : SWB022-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.14 v9.0.0, 0.11 v8.2.0, 0.00 v7.3.0
% Syntax   : Number of clauses     :  110 ( 110 unt;   0 nHn;  81 RR)
%            Number of literals    :  110 ( 110 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   58 (  58 usr;  50 con; 0-4 aty)
%            Number of variables   :   54 (  10 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from SWB022+4 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(testcase_premise_fullish_022_List_Member_Access_18,axiom,
    iext(uri_owl_propertyChainAxiom,sK6_testcase_premise_fullish_022_List_Member_Access_BNODE_pL,sK7_testcase_premise_fullish_022_List_Member_Access_BNODE_l21) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_17,axiom,
    iext(uri_owl_propertyChainAxiom,uri_skos_member,sK8_testcase_premise_fullish_022_List_Member_Access_BNODE_l11) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_16,axiom,
    iext(uri_skos_memberList,uri_ex_MyOrderedCollection,sK2_testcase_premise_fullish_022_List_Member_Access_BNODE_l31) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_15,axiom,
    iext(uri_rdf_rest,sK1_testcase_premise_fullish_022_List_Member_Access_BNODE_l33,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_14,axiom,
    iext(uri_rdf_rest,sK2_testcase_premise_fullish_022_List_Member_Access_BNODE_l31,sK3_testcase_premise_fullish_022_List_Member_Access_BNODE_l32) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_13,axiom,
    iext(uri_rdf_rest,sK3_testcase_premise_fullish_022_List_Member_Access_BNODE_l32,sK1_testcase_premise_fullish_022_List_Member_Access_BNODE_l33) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_12,axiom,
    iext(uri_rdf_rest,sK4_testcase_premise_fullish_022_List_Member_Access_BNODE_l22,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_11,axiom,
    iext(uri_rdf_rest,sK5_testcase_premise_fullish_022_List_Member_Access_BNODE_l12,uri_rdf_nil) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_10,axiom,
    iext(uri_rdf_rest,sK7_testcase_premise_fullish_022_List_Member_Access_BNODE_l21,sK4_testcase_premise_fullish_022_List_Member_Access_BNODE_l22) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_9,axiom,
    iext(uri_rdf_rest,sK8_testcase_premise_fullish_022_List_Member_Access_BNODE_l11,sK5_testcase_premise_fullish_022_List_Member_Access_BNODE_l12) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_8,axiom,
    iext(uri_rdf_first,sK1_testcase_premise_fullish_022_List_Member_Access_BNODE_l33,uri_ex_Z) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_7,axiom,
    iext(uri_rdf_first,sK2_testcase_premise_fullish_022_List_Member_Access_BNODE_l31,uri_ex_X) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_6,axiom,
    iext(uri_rdf_first,sK3_testcase_premise_fullish_022_List_Member_Access_BNODE_l32,uri_ex_Y) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_5,axiom,
    iext(uri_rdf_first,sK4_testcase_premise_fullish_022_List_Member_Access_BNODE_l22,uri_rdf_rest) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_4,axiom,
    iext(uri_rdf_first,sK5_testcase_premise_fullish_022_List_Member_Access_BNODE_l12,uri_rdf_first) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_3,axiom,
    iext(uri_rdf_first,sK7_testcase_premise_fullish_022_List_Member_Access_BNODE_l21,sK6_testcase_premise_fullish_022_List_Member_Access_BNODE_pL) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_2,axiom,
    iext(uri_rdf_first,sK8_testcase_premise_fullish_022_List_Member_Access_BNODE_l11,sK6_testcase_premise_fullish_022_List_Member_Access_BNODE_pL) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access_1,axiom,
    iext(uri_rdf_type,uri_ex_MyOrderedCollection,uri_skos_OrderedCollection) = true ).

cnf(testcase_premise_fullish_022_List_Member_Access,axiom,
    iext(uri_rdfs_subPropertyOf,uri_skos_memberList,sK6_testcase_premise_fullish_022_List_Member_Access_BNODE_pL) = true ).

cnf(testcase_conclusion_fullish_022_List_Member_Access,negated_conjecture,
    tuple(iext(uri_skos_member,uri_ex_MyOrderedCollection,uri_ex_Y),iext(uri_skos_member,uri_ex_MyOrderedCollection,uri_ex_X),iext(uri_skos_member,uri_ex_MyOrderedCollection,uri_ex_Z)) != tuple(true,true,true) ).
