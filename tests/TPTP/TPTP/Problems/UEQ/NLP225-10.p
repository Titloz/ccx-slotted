%------------------------------------------------------------------------------
% File     : NLP225-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Syntax   : Number of clauses     :   97 (  97 unt;   0 nHn;  19 RR)
...
% Comments : Converted from NLP225-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause90,negated_conjecture,
    ifeq2(man(skc11,U),true,smoke(skc11,skf1(V)),true) = true ).

cnf(clause91,negated_conjecture,
    ifeq2(man(skc11,U),true,present(skc11,skf1(V)),true) = true ).

cnf(clause92,negated_conjecture,
    ifeq2(man(skc11,U),true,event(skc11,skf1(V)),true) = true ).

cnf(clause93,negated_conjecture,
    ifeq2(man(skc11,U),true,agent(skc11,skf1(U),U),true) = true ).
