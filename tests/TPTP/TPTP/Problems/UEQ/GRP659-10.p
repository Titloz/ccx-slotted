%------------------------------------------------------------------------------
% File     : GRP659-10 : TPTP v9.0.0. Released v8.1.0.
...
% Rating   : 0.32 v8.2.0, 0.33 v8.1.0
...
% Comments : UEQ version, converted from GRP659+1.p
%------------------------------------------------------------------------------
cnf(f01,axiom,
    mult(A,ld(A,B)) = B ).
...
cnf(f05,axiom,
    mult(mult(A,mult(B,C)),B) = mult(mult(A,B),mult(C,B)) ).
