%------------------------------------------------------------------------------
% File     : LCL330-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 5.25
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL330-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(equivalent(or(p,q),implies(implies(p,q),q))) != true ).
