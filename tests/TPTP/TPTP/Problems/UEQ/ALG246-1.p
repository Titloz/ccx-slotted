%------------------------------------------------------------------------------
% File     : ALG246-1 : TPTP v9.0.0. Released v4.0.0.
% Domain   : Group Theory (Quasigroups)
% Problem  : Axioms of SBL algebras are fnot independent
% Version  : Especial.
% English  :
...
% Rating   : 0.73 v9.0.0, 0.68 v8.2.0, 0.71 v8.1.0, 0.80 v7.5.0, 0.79 v7.4.0, 0.87 v7.3.0, 0.79 v7.1.0, 0.78 v7.0.0, 0.74 v6.4.0, 0.79 v6.3.0, 0.82 v6.2.0, 0.86 v6.1.0, 0.88 v6.0.0, 0.90 v5.5.0, 0.84 v5.4.0, 0.80 v5.3.0, 0.75 v5.2.0, 0.79 v5.1.0, 0.80 v5.0.0, 0.79 v4.1.0, 0.73 v4.0.1, 0.79 v4.0.0
...
%            fnot legal TPTP symbols, and we have replaced those symbols with
