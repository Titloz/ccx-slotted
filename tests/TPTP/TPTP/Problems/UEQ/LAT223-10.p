%------------------------------------------------------------------------------
% File     : LAT223-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Equation H7 is Huntington by implication
% Version  : Especial.
% English  :
...
% Rating   : 0.91 v8.2.0, 0.88 v8.1.0, 0.95 v7.5.0
...
% Comments : Converted from LAT223-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
