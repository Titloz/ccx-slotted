%------------------------------------------------------------------------------
% File     : LAT186-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Equation H11 is Huntington by distributivity
% Version  : Especial.
% English  :
...
% Rating   : 0.82 v8.2.0, 0.83 v8.1.0, 0.95 v7.5.0, 0.92 v7.4.0, 0.96 v7.3.0
...
% Comments : Converted from LAT186-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
