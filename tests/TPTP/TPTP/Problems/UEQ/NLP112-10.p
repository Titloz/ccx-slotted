%------------------------------------------------------------------------------
% File     : NLP112-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Comments : Converted from NLP112-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause40,negated_conjecture,
    nonreflexive(skc5,skc7) = true ).

cnf(clause41,negated_conjecture,
    drink(skc5,skc7) = true ).

cnf(clause42,negated_conjecture,
    restaurant(skc5,skc6) = true ).

cnf(clause43,negated_conjecture,
    agent(skc5,skc7,skc8) = true ).

cnf(clause44,negated_conjecture,
    patient(skc5,skc7,skc10) = true ).

cnf(clause45,negated_conjecture,
    ifeq3(in(skc5,U,skc6),true,ifeq3(customer(skc5,U),true,see(skc5,skf1(V)),true),true) = true ).

cnf(clause46,negated_conjecture,
    ifeq3(in(skc5,U,skc6),true,ifeq3(customer(skc5,U),true,nonreflexive(skc5,skf1(V)),true),true) = true ).

cnf(clause47,negated_conjecture,
    ifeq3(in(skc5,U,skc6),true,ifeq3(customer(skc5,U),true,past(skc5,skf1(V)),true),true) = true ).

cnf(clause48,negated_conjecture,
    ifeq3(in(skc5,U,skc6),true,ifeq3(customer(skc5,U),true,event(skc5,skf1(V)),true),true) = true ).

cnf(clause49,negated_conjecture,
    ifeq3(in(skc5,U,skc6),true,ifeq3(customer(skc5,U),true,patient(skc5,skf1(V),skc8),true),true) = true ).

cnf(clause50,negated_conjecture,
    ifeq3(in(skc5,U,skc6),true,ifeq3(customer(skc5,U),true,agent(skc5,skf1(U),U),true),true) = true ).
