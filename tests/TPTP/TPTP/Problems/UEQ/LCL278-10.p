%------------------------------------------------------------------------------
% File     : LCL278-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : Principia Mathematica 4.37
% Version  : Especial.
% English  :
...
% Comments : Converted from LCL278-3 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(prove_this,negated_conjecture,
    theorem(implies(equivalent(p,q),equivalent(or(p,r),or(q,r)))) != true ).
