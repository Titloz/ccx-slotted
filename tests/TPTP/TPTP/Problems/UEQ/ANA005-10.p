%------------------------------------------------------------------------------
% File     : ANA005-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
...
% Comments : Converted from ANA005-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(c_16,negated_conjecture,
    ifeq(tuple(less_than(n0,X),less_than(absolute(add(add(f(fp33(X)),g(fp33(X))),minus(add(l1,l2)))),b)),tuple(true,true),a2,b2) = b2 ).
