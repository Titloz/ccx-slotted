%------------------------------------------------------------------------------
% File     : NLP241-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : Vincent believes that every man smokes, problem 22
% Version  : Especial.
% English  :
...
% Status   : Satisfiable
% Rating   : 0.29 v9.0.0, 0.22 v8.2.0, 0.20 v8.1.0, 0.25 v7.4.0, 0.50 v7.3.0
% Syntax   : Number of clauses     :  116 ( 116 unt;   0 nHn;  38 RR)
%            Number of literals    :  116 ( 116 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :   10 (   1 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   59 (  59 usr;  18 con; 0-4 aty)
%            Number of variables   :  205 (  11 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from NLP241-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause72,negated_conjecture,
    actual_world(skc15) = true ).

cnf(clause73,negated_conjecture,
    man(skc15,skc29) = true ).

cnf(clause74,negated_conjecture,
    forename(skc15,skc28) = true ).

cnf(clause75,negated_conjecture,
    vincent_forename(skc15,skc28) = true ).

cnf(clause76,negated_conjecture,
    event(skc15,skc27) = true ).

cnf(clause77,negated_conjecture,
    present(skc15,skc27) = true ).

cnf(clause78,negated_conjecture,
    think_believe_consider(skc15,skc27) = true ).

cnf(clause79,negated_conjecture,
    jules_forename(skc15,skc25) = true ).

cnf(clause80,negated_conjecture,
    forename(skc15,skc25) = true ).

cnf(clause81,negated_conjecture,
    man(skc15,skc24) = true ).

cnf(clause82,negated_conjecture,
    event(skc16,skc22) = true ).

cnf(clause83,negated_conjecture,
    man(skc15,skc21) = true ).

cnf(clause84,negated_conjecture,
    present(skc16,skc22) = true ).

cnf(clause85,negated_conjecture,
    smoke(skc16,skc22) = true ).

cnf(clause86,negated_conjecture,
    man(skc15,skc19) = true ).

cnf(clause87,negated_conjecture,
    think_believe_consider(skc15,skc17) = true ).

cnf(clause88,negated_conjecture,
    present(skc15,skc17) = true ).

cnf(clause89,negated_conjecture,
    event(skc15,skc17) = true ).

cnf(clause90,negated_conjecture,
    forename(skc15,skc18) = true ).

cnf(clause91,negated_conjecture,
    vincent_forename(skc15,skc18) = true ).

cnf(clause92,negated_conjecture,
    forename(skc15,skc20) = true ).

cnf(clause93,negated_conjecture,
    jules_forename(skc15,skc20) = true ).

cnf(clause94,negated_conjecture,
    proposition(skc15,skc16) = true ).

cnf(clause95,negated_conjecture,
    accessible_world(skc15,skc16) = true ).

cnf(clause96,negated_conjecture,
    state(skc15,skc23) = true ).

cnf(clause97,negated_conjecture,
    accessible_world(skc15,skc26) = true ).

cnf(clause98,negated_conjecture,
    proposition(skc15,skc26) = true ).

cnf(clause99,negated_conjecture,
    of(skc15,skc28,skc29) = true ).

cnf(clause100,negated_conjecture,
    agent(skc15,skc27,skc29) = true ).

cnf(clause101,negated_conjecture,
    theme(skc15,skc27,skc26) = true ).

cnf(clause102,negated_conjecture,
    of(skc15,skc25,skc24) = true ).

cnf(clause103,negated_conjecture,
    of(skc15,skc20,skc21) = true ).

cnf(clause104,negated_conjecture,
    agent(skc16,skc22,skc21) = true ).

cnf(clause105,negated_conjecture,
    of(skc15,skc18,skc19) = true ).

cnf(clause106,negated_conjecture,
    agent(skc15,skc17,skc19) = true ).

cnf(clause107,negated_conjecture,
    theme(skc15,skc17,skc16) = true ).

cnf(clause108,negated_conjecture,
    be(skc15,skc23,skc24,skc24) = true ).

cnf(clause109,negated_conjecture,
    ifeq2(man(skc26,U),true,smoke(skc26,skf1(V)),true) = true ).

cnf(clause110,negated_conjecture,
    ifeq2(man(skc26,U),true,present(skc26,skf1(V)),true) = true ).

cnf(clause111,negated_conjecture,
    ifeq2(man(skc26,U),true,event(skc26,skf1(V)),true) = true ).

cnf(clause112,negated_conjecture,
    ifeq2(man(skc26,U),true,agent(skc26,skf1(U),U),true) = true ).
