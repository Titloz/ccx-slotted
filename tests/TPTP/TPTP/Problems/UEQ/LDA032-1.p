%------------------------------------------------------------------------------
% File     : LDA032-1 : TPTP v9.0.0. Released v4.1.0.
% Domain   : LD-Algebras
% Problem  : Identity 26 in the equational theory of group conjugation
% Version  : Especial.
% English  :
...
% Status   : Satisfiable
% Rating   : 0.86 v9.0.0, 0.78 v8.2.0, 0.60 v8.1.0, 0.50 v7.5.0, 0.25 v7.1.0, 0.33 v7.0.0, 0.00 v6.4.0, 0.50 v6.3.0, 0.33 v6.2.0, 0.83 v6.1.0, 0.80 v5.4.0, 0.75 v5.3.0, 0.67 v4.1.0
...
cnf(sos04,axiom,
    product(product(product(product(A,B),product(A,C)),product(A,C)),product(product(A,B),product(product(A,D),D))) = product(product(product(A,B),product(A,C)),product(product(A,product(C,B)),product(product(A,D),D))) ).
