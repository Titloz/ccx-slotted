%--------------------------------------------------------------------------
% File     : COL063-5 : TPTP v9.0.0. Bugfixed v1.2.0.
...
% Rating   : 0.09 v9.0.0, 0.05 v8.2.0, 0.08 v8.1.0, 0.15 v7.5.0, 0.12 v7.4.0, 0.17 v7.3.0, 0.11 v7.1.0, 0.00 v7.0.0, 0.11 v6.4.0, 0.16 v6.3.0, 0.18 v6.2.0, 0.21 v6.1.0, 0.06 v6.0.0, 0.19 v5.5.0, 0.21 v5.4.0, 0.00 v5.2.0, 0.07 v4.1.0, 0.09 v4.0.1, 0.07 v4.0.0, 0.08 v3.7.0, 0.11 v3.4.0, 0.12 v3.3.0, 0.00 v2.2.1, 0.11 v2.2.0, 0.14 v2.1.0, 0.43 v2.0.0
...
cnf(prove_f_combinator,negated_conjecture,
    apply(apply(apply(apply(apply(b,apply(apply(b,apply(t,t)),apply(apply(b,b),b))),t),x),y),z) != apply(apply(z,y),x) ).
