%--------------------------------------------------------------------------
% File     : GRP147-1 : TPTP v9.0.0. Bugfixed v1.2.1.
...
% Rating   : 0.00 v8.2.0, 0.04 v8.1.0, 0.05 v7.5.0, 0.04 v7.4.0, 0.09 v7.3.0, 0.00 v7.0.0, 0.11 v6.4.0, 0.16 v6.3.0, 0.12 v6.2.0, 0.14 v6.1.0, 0.06 v6.0.0, 0.29 v5.5.0, 0.26 v5.4.0, 0.07 v5.3.0, 0.00 v5.2.0, 0.07 v5.0.0, 0.00 v4.0.0, 0.08 v3.7.0, 0.00 v3.4.0, 0.12 v3.3.0, 0.00 v2.2.1, 0.33 v2.2.0, 0.43 v2.1.0, 0.43 v2.0.0
...
%--------------------------------------------------------------------------
cnf(ax_lub1b_1,hypothesis,
    greatest_lower_bound(a,c) = a ).

cnf(ax_lub1b_2,hypothesis,
    greatest_lower_bound(b,c) = b ).

cnf(prove_ax_lub1b,negated_conjecture,
