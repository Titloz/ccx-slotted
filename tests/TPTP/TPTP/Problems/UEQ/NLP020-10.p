%------------------------------------------------------------------------------
% File     : NLP020-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.29 v9.0.0, 0.22 v8.2.0, 0.00 v7.5.0
% Syntax   : Number of clauses     :   72 (  72 unt;   0 nHn;  22 RR)
%            Number of literals    :   72 (  72 equ;   1 neg)
%            Maximal clause size   :    1 (   1 avg)
%            Maximal term depth    :    5 (   2 avg)
%            Number of predicates  :    1 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :   56 (  56 usr;   9 con; 0-4 aty)
%            Number of variables   :   71 (  11 sgn)
% SPC      : CNF_SAT_RFO_PEQ_UEQ

% Comments : Converted from NLP020-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
...
cnf(clause66,negated_conjecture,
    barrel(skc10,skc8) = true ).

cnf(clause67,negated_conjecture,
    down(skc10,skc9) = true ).
